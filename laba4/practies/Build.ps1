...
$Manifest = @{
    ...
    Description = 'PSOpenAPITools - the PowerShell module for RUVDS API'

    ModuleVersion = '0.1.2'

    RootModule = 'PSOpenAPITools.psm1'
    Guid = '{58C3AF81-72A8-4DE9-AC0F-62A641C3ACFE}' # Has to be static, otherwise each new build will be considered different module
