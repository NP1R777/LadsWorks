...
Describe -tag 'PSOpenAPITools' -name 'StatisticsApi' {
    Context 'Invoke-CpuDailyStat' {
        It 'Test Invoke-CpuDailyStat' {
            #$TestResult = Invoke-CpuDailyStat -VirtualServerId "TEST_VALUE" -Sort "TEST_VALUE" -Order "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-CpuHourlyStat' {
        It 'Test Invoke-CpuHourlyStat' {
            #$TestResult = Invoke-CpuHourlyStat -VirtualServerId "TEST_VALUE" -Sort "TEST_VALUE" -Order "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-DriveDailyStat' {
        It 'Test Invoke-DriveDailyStat' {
            #$TestResult = Invoke-DriveDailyStat -VirtualServerId "TEST_VALUE" -Sort "TEST_VALUE" -Order "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-DriveHourlyStat' {
        It 'Test Invoke-DriveHourlyStat' {
            #$TestResult = Invoke-DriveHourlyStat -VirtualServerId "TEST_VALUE" -Sort "TEST_VALUE" -Order "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-NetworkDailyStat' {
        It 'Test Invoke-NetworkDailyStat' {
            #$TestResult = Invoke-NetworkDailyStat -VirtualServerId "TEST_VALUE" -Sort "TEST_VALUE" -Order "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-NetworkHourlyStat' {
        It 'Test Invoke-NetworkHourlyStat' {
            #$TestResult = Invoke-NetworkHourlyStat -VirtualServerId "TEST_VALUE" -Sort "TEST_VALUE" -Order "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
