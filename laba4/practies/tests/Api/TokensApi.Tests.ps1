...
Describe -tag 'PSOpenAPITools' -name 'TokensApi' {
    Context 'Invoke-TokensCreate' {
        It 'Test Invoke-TokensCreate' {
            #$TestResult = Invoke-TokensCreate -TokenCreate "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-TokensGet' {
        It 'Test Invoke-TokensGet' {
            #$TestResult = Invoke-TokensGet -TokenId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-TokensList' {
        It 'Test Invoke-TokensList' {
            #$TestResult = Invoke-TokensList
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-TokensPut' {
        It 'Test Invoke-TokensPut' {
            #$TestResult = Invoke-TokensPut -TokenId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
