...
Describe -tag 'PSOpenAPITools' -name 'SSHKeysApi' {
    Context 'Invoke-SshKeysCreate' {
        It 'Test Invoke-SshKeysCreate' {
            #$TestResult = Invoke-SshKeysCreate -SshKeyCreate "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-SshKeysDelete' {
        It 'Test Invoke-SshKeysDelete' {
            #$TestResult = Invoke-SshKeysDelete -SshKeyId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-SshKeysGet' {
        It 'Test Invoke-SshKeysGet' {
            #$TestResult = Invoke-SshKeysGet -SshKeyId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-SshKeysList' {
        It 'Test Invoke-SshKeysList' {
            #$TestResult = Invoke-SshKeysList
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
