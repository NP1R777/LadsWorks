...
AllDatacentersResponse<PSCustomObject>
#>

function Initialize-AllDatacentersResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AllDatacentersResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        if ($null -eq $Datacenters) {
            throw "invalid value for 'Datacenters', 'Datacenters' cannot be null."
        }
...
Convert from JSON to AllDatacentersResponse<PSCustomObject>
...
AllDatacentersResponse<PSCustomObject>
#>
function ConvertFrom-JsonToAllDatacentersResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AllDatacentersResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AllDatacentersResponse
        $AllProperties = ("datacenters")
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'datacenters' missing."
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "datacenters"))) {
            throw "Error! JSON cannot be serialized due to the required property 'datacenters' missing."
        } else {
