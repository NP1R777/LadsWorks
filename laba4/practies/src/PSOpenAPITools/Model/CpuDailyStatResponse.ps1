...
CpuDailyStatResponse<PSCustomObject>
#>

function Initialize-CpuDailyStatResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CpuDailyStatResponse' | Write-Debug
...
Convert from JSON to CpuDailyStatResponse<PSCustomObject>
...
CpuDailyStatResponse<PSCustomObject>
#>
function ConvertFrom-JsonToCpuDailyStatResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CpuDailyStatResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CpuDailyStatResponse
