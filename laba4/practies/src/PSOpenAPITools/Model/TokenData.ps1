...
function Initialize-TokenData {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TokenData' | Write-Debug
        ...
        if ($null -eq $TokenSecret) {
            throw "invalid value for 'TokenSecret', 'TokenSecret' cannot be null."
        }
...
Convert from JSON to TokenData<PSCustomObject>
...
TokenData<PSCustomObject>
#>
function ConvertFrom-JsonToTokenData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TokenData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TokenData
        $AllProperties = ("token_id", "token_secret")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "token_secret"))) {
            throw "Error! JSON cannot be serialized due to the required property 'token_secret' missing."
        } else {
            $TokenSecret = $JsonParameters.PSobject.Properties["token_secret"].value
        }
