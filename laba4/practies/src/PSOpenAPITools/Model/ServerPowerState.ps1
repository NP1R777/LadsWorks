...
ServerPowerState<PSCustomObject>
#>

function Initialize-ServerPowerState {
    [CmdletBinding()]
    Param (
        ...
        [ValidateSet("running", "off", "starting", "stopping")]
        [String]
        ${PowerState}
    )

    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServerPowerState' | Write-Debug
...
Convert from JSON to ServerPowerState<PSCustomObject>
...
ServerPowerState<PSCustomObject>
#>
function ConvertFrom-JsonToServerPowerState {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServerPowerState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServerPowerState
        $AllProperties = ("virtual_server_id", "power_state")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "power_state"))) {
            throw "Error! JSON cannot be serialized due to the required property 'power_state' missing."
        } else {
            $PowerState = $JsonParameters.PSobject.Properties["power_state"].value
        }
