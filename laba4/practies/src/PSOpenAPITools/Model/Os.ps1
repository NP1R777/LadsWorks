...
function Initialize-Os {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Os' | Write-Debug
...
function ConvertFrom-JsonToOs {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Os' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Os
        $AllProperties = ("id", "name", "is_active")
