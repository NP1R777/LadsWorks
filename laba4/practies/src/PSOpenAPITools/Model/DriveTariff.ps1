...
DriveTariff<PSCustomObject>
#>

function Initialize-DriveTariff {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DriveTariff' | Write-Debug
...
Convert from JSON to DriveTariff<PSCustomObject>
...
DriveTariff<PSCustomObject>
#>
function ConvertFrom-JsonToDriveTariff {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DriveTariff' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DriveTariff
