...
ID шаблона виртуального сервера.
.PARAMETER Name
Имя шаблона.
.OUTPUTS
...
function Initialize-Template {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Template' | Write-Debug
...
Convert from JSON to Template<PSCustomObject>
...
Template<PSCustomObject>
#>
function ConvertFrom-JsonToTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Template' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Template
        $AllProperties = ("template_id", "name")
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'template_id' missing."
        }
