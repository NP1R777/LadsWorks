...
ServerChange<PSCustomObject>
#>

function Initialize-ServerChange {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServerChange' | Write-Debug
...
Convert from JSON to ServerChange<PSCustomObject>
...
ServerChange<PSCustomObject>
#>
function ConvertFrom-JsonToServerChange {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServerChange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServerChange
        $AllProperties = ("virtual_server_id", "cpu", "ram", "vram", "drive", "ip")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "drive"))) { #optional property not found
            $Drive = $null
        } else {
