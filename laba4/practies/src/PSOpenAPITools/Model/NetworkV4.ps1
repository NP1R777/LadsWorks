...
NetworkV4<PSCustomObject>
#>

function Initialize-NetworkV4 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NetworkV4' | Write-Debug
...
Convert from JSON to NetworkV4<PSCustomObject>
...
NetworkV4<PSCustomObject>
#>
function ConvertFrom-JsonToNetworkV4 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NetworkV4' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NetworkV4
        $AllProperties = ("ip_address", "netmask", "gateway")
