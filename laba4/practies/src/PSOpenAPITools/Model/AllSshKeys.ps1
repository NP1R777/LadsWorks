...
AllSshKeys<PSCustomObject>
#>

function Initialize-AllSshKeys {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AllSshKeys' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        if ($null -eq $SshKeys) {
            throw "invalid value for 'SshKeys', 'SshKeys' cannot be null."
        }
...
Convert from JSON to AllSshKeys<PSCustomObject>
...
AllSshKeys<PSCustomObject>
#>
function ConvertFrom-JsonToAllSshKeys {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AllSshKeys' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AllSshKeys
        $AllProperties = ("ssh_keys")
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'ssh_keys' missing."
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ssh_keys"))) {
            throw "Error! JSON cannot be serialized due to the required property 'ssh_keys' missing."
        } else {
            $SshKeys = $JsonParameters.PSobject.Properties["ssh_keys"].value
        }
