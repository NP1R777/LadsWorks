...
AllOsResponse<PSCustomObject>
#>

function Initialize-AllOsResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AllOsResponse' | Write-Debug
...
Convert from JSON to AllOsResponse<PSCustomObject>
...
AllOsResponse<PSCustomObject>
#>
function ConvertFrom-JsonToAllOsResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AllOsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AllOsResponse
        $AllProperties = ("os")
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'os' missing."
        }
