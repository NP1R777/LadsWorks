...
ServerActionCreate<PSCustomObject>
#>

function Initialize-ServerActionCreate {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("power_on", "power_off", "shutdown", "reboot")]
        [String]
        ${Type}
    )

    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServerActionCreate' | Write-Debug
...
Convert from JSON to ServerActionCreate<PSCustomObject>
...
ServerActionCreate<PSCustomObject>
#>
function ConvertFrom-JsonToServerActionCreate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServerActionCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServerActionCreate
        $AllProperties = ("type")
