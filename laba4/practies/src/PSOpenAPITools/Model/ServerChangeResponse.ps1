...
ServerChangeResponse<PSCustomObject>
#>

function Initialize-ServerChangeResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServerChangeResponse' | Write-Debug
...
Convert from JSON to ServerChangeResponse<PSCustomObject>
...
ServerChangeResponse<PSCustomObject>
#>
function ConvertFrom-JsonToServerChangeResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServerChangeResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServerChangeResponse
        $AllProperties = ("cost_rub", "action")
