...
AllTokensResponse<PSCustomObject>
#>

function Initialize-AllTokensResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AllTokensResponse' | Write-Debug
...
Convert from JSON to AllTokensResponse<PSCustomObject>
...
AllTokensResponse<PSCustomObject>
#>
function ConvertFrom-JsonToAllTokensResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AllTokensResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AllTokensResponse
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'tokens' missing."
        }
