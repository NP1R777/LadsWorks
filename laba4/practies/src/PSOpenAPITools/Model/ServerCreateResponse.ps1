...
ServerCreateResponse<PSCustomObject>
#>

function Initialize-ServerCreateResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServerCreateResponse' | Write-Debug
...
Convert from JSON to ServerCreateResponse<PSCustomObject>
...
ServerCreateResponse<PSCustomObject>
#>
function ConvertFrom-JsonToServerCreateResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServerCreateResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServerCreateResponse
        $AllProperties = ("virtual_server_id", "payment_period", "cost_rub", "password", "action", "status")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "virtual_server_id"))) { #optional property not found
            $VirtualServerId = $null
        } else {
            $VirtualServerId = $JsonParameters.PSobject.Properties["virtual_server_id"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "payment_period"))) { #optional property not found
            $PaymentPeriod = $null
        } else {
            $PaymentPeriod = $JsonParameters.PSobject.Properties["payment_period"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "cost_rub"))) { #optional property not found
            $CostRub = $null
        } else {
