...
AllTemplatesResponse<PSCustomObject>
#>

function Initialize-AllTemplatesResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AllTemplatesResponse' | Write-Debug
...
Convert from JSON to AllTemplatesResponse<PSCustomObject>
...
AllTemplatesResponse<PSCustomObject>
#>
function ConvertFrom-JsonToAllTemplatesResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AllTemplatesResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AllTemplatesResponse
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'templates' missing."
        }
