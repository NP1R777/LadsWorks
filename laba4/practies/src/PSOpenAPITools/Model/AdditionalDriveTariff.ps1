...
AdditionalDriveTariff<PSCustomObject>
#>

function Initialize-AdditionalDriveTariff {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdditionalDriveTariff' | Write-Debug
...
Convert from JSON to AdditionalDriveTariff<PSCustomObject>
...
AdditionalDriveTariff<PSCustomObject>
#>
function ConvertFrom-JsonToAdditionalDriveTariff {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdditionalDriveTariff' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdditionalDriveTariff
