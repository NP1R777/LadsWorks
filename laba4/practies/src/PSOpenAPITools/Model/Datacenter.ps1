...
.PARAMETER AdditionalDriveTariffs
...
.PARAMETER AdditionalServiceTariffs
...
function Initialize-Datacenter {
    ...
    Param (
        ...
        [Int32[]]
        ${AdditionalDriveTariffs},
        [Parameter(Position = 5, ValueFromPipelineByPropertyName = $true)]
        [Int32[]]
        ${AdditionalServiceTariffs}
    )

    Process {
        'Creating PSCustomObject: PSOpenAPITools => Datacenter' | Write-Debug
        ...
        if ($null -eq $VpsTariffs) {
            throw "invalid value for 'VpsTariffs', 'VpsTariffs' cannot be null."
        }

        if ($null -eq $DriveTariffs) {
            throw "invalid value for 'DriveTariffs', 'DriveTariffs' cannot be null."
        }

        if ($null -eq $AdditionalDriveTariffs) {
            throw "invalid value for 'AdditionalDriveTariffs', 'AdditionalDriveTariffs' cannot be null."
        }

        if ($null -eq $AdditionalServiceTariffs) {
            throw "invalid value for 'AdditionalServiceTariffs', 'AdditionalServiceTariffs' cannot be null."
        }
        ...
        $PSO = [PSCustomObject]@{
            "id" = ${Id}
            "name" = ${Name}
            "vps_tariffs" = ${VpsTariffs}
            "drive_tariffs" = ${DriveTariffs}
            "additional_drive_tariffs" = ${AdditionalDriveTariffs}
            "additional_service_tariffs" = ${AdditionalServiceTariffs}
        }
...
Convert from JSON to Datacenter<PSCustomObject>
...
Datacenter<PSCustomObject>
#>
function ConvertFrom-JsonToDatacenter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Datacenter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Datacenter
        $AllProperties = ("id", "name", "vps_tariffs", "drive_tariffs", "additional_drive_tariffs", "additional_service_tariffs")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "vps_tariffs"))) {
            throw "Error! JSON cannot be serialized due to the required property 'vps_tariffs' missing."
        } else {
            $VpsTariffs = $JsonParameters.PSobject.Properties["vps_tariffs"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "drive_tariffs"))) {
            throw "Error! JSON cannot be serialized due to the required property 'drive_tariffs' missing."
        } else {
            $DriveTariffs = $JsonParameters.PSobject.Properties["drive_tariffs"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "additional_drive_tariffs"))) {
            throw "Error! JSON cannot be serialized due to the required property 'additional_drive_tariffs' missing."
        } else {
            $AdditionalDriveTariffs = $JsonParameters.PSobject.Properties["additional_drive_tariffs"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "additional_service_tariffs"))) {
            throw "Error! JSON cannot be serialized due to the required property 'additional_service_tariffs' missing."
        } else {
            $AdditionalServiceTariffs = $JsonParameters.PSobject.Properties["additional_service_tariffs"].value
        }
