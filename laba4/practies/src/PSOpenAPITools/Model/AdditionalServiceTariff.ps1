...
AdditionalServiceTariff<PSCustomObject>
#>

function Initialize-AdditionalServiceTariff {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdditionalServiceTariff' | Write-Debug
...
Convert from JSON to AdditionalServiceTariff<PSCustomObject>
...
AdditionalServiceTariff<PSCustomObject>
#>
function ConvertFrom-JsonToAdditionalServiceTariff {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdditionalServiceTariff' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdditionalServiceTariff
        $AllProperties = ("id", "name", "price", "is_active")
