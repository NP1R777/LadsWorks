...
NotificationChange<PSCustomObject>
#>

function Initialize-NotificationChange {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NotificationChange' | Write-Debug
...
Convert from JSON to NotificationChange<PSCustomObject>
...
NotificationChange<PSCustomObject>
#>
function ConvertFrom-JsonToNotificationChange {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NotificationChange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NotificationChange
