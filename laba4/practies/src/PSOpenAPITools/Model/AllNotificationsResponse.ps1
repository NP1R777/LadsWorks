...
AllNotificationsResponse<PSCustomObject>
#>

function Initialize-AllNotificationsResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AllNotificationsResponse' | Write-Debug
...
Convert from JSON to AllNotificationsResponse<PSCustomObject>
...
AllNotificationsResponse<PSCustomObject>
#>
function ConvertFrom-JsonToAllNotificationsResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AllNotificationsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AllNotificationsResponse
        $AllProperties = ("notifications", "pagination")
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'notifications' missing."
        }
