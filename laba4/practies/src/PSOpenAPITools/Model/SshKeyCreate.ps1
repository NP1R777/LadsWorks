...
SshKeyCreate<PSCustomObject>
#>

function Initialize-SshKeyCreate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SshKeyCreate' | Write-Debug
...
Convert from JSON to SshKeyCreate<PSCustomObject>
...
SshKeyCreate<PSCustomObject>
#>
function ConvertFrom-JsonToSshKeyCreate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SshKeyCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SshKeyCreate
        $AllProperties = ("public_key", "name")
