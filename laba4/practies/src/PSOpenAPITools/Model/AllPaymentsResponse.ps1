...
AllPaymentsResponse<PSCustomObject>
#>

function Initialize-AllPaymentsResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AllPaymentsResponse' | Write-Debug
...
Convert from JSON to AllPaymentsResponse<PSCustomObject>
...
AllPaymentsResponse<PSCustomObject>
#>
function ConvertFrom-JsonToAllPaymentsResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AllPaymentsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AllPaymentsResponse
        $AllProperties = ("payments", "pagination")
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'payments' missing."
        }
