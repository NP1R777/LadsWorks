...
ApiForbiddenError<PSCustomObject>
#>

function Initialize-ApiForbiddenError {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("forbidden", "email_not_confirmed", "phone_not_confirmed", "server_creation_forbidden")]
        [String]
        ${Id},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiForbiddenError' | Write-Debug
...
Convert from JSON to ApiForbiddenError<PSCustomObject>
...
ApiForbiddenError<PSCustomObject>
#>
function ConvertFrom-JsonToApiForbiddenError {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiForbiddenError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiForbiddenError
        $AllProperties = ("id", "user_id", "message")
