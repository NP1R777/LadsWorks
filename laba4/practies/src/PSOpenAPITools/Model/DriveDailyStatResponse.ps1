...
DriveDailyStatResponse<PSCustomObject>
#>

function Initialize-DriveDailyStatResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DriveDailyStatResponse' | Write-Debug
...
Convert from JSON to DriveDailyStatResponse<PSCustomObject>
...
DriveDailyStatResponse<PSCustomObject>
#>
function ConvertFrom-JsonToDriveDailyStatResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DriveDailyStatResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DriveDailyStatResponse
