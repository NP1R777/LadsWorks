...
NetworkDailyStatResponse<PSCustomObject>
#>

function Initialize-NetworkDailyStatResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NetworkDailyStatResponse' | Write-Debug
...
Convert from JSON to NetworkDailyStatResponse<PSCustomObject>
...
NetworkDailyStatResponse<PSCustomObject>
#>
function ConvertFrom-JsonToNetworkDailyStatResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NetworkDailyStatResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NetworkDailyStatResponse
