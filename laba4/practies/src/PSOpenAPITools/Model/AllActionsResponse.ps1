...
AllActionsResponse<PSCustomObject>
#>

function Initialize-AllActionsResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AllActionsResponse' | Write-Debug
...
Convert from JSON to AllActionsResponse<PSCustomObject>
...
AllActionsResponse<PSCustomObject>
#>
function ConvertFrom-JsonToAllActionsResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AllActionsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AllActionsResponse
        $AllProperties = ("actions", "pagination")
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'actions' missing."
        }
