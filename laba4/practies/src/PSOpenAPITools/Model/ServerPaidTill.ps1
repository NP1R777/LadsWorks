...
ServerPaidTill<PSCustomObject>
#>

function Initialize-ServerPaidTill {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServerPaidTill' | Write-Debug
...
Convert from JSON to ServerPaidTill<PSCustomObject>
...
ServerPaidTill<PSCustomObject>
#>
function ConvertFrom-JsonToServerPaidTill {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServerPaidTill' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServerPaidTill
        $AllProperties = ("virtual_server_id", "paid_till")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "paid_till"))) { #optional property not found
            $PaidTill = $null
        } else {
            $PaidTill = $JsonParameters.PSobject.Properties["paid_till"].value
        }
