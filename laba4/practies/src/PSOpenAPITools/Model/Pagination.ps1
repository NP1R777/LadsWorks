...
function ConvertFrom-JsonToPagination {
    ...
    Process {
        ...
        $AllProperties = ("page", "per_page", "previous_page", "next_page", "last_page", "total_entries")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "per_page"))) { #optional property not found
            $PerPage = $null
        } else {
            $PerPage = $JsonParameters.PSobject.Properties["per_page"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "previous_page"))) { #optional property not found
            $PreviousPage = $null
        } else {
            $PreviousPage = $JsonParameters.PSobject.Properties["previous_page"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "next_page"))) { #optional property not found
            $NextPage = $null
        } else {
            $NextPage = $JsonParameters.PSobject.Properties["next_page"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "last_page"))) { #optional property not found
            $LastPage = $null
        } else {
            $LastPage = $JsonParameters.PSobject.Properties["last_page"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "total_entries"))) { #optional property not found
            $TotalEntries = $null
        } else {
            $TotalEntries = $JsonParameters.PSobject.Properties["total_entries"].value
        }
