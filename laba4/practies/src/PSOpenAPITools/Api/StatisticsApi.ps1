...
function Invoke-CpuDailyStat {
    ...
    Process {
        'Calling method: Invoke-CpuDailyStat' | Write-Debug
        ...
        $LocalVarUri = '/v2/stat/cpu/daily/{virtual_server_id}'
        if (!$VirtualServerId) {
            throw "Error! The required parameter `VirtualServerId` missing when calling cpuDailyStat."
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -ReturnType "CpuDailyStatResponse" `
...
function Invoke-CpuHourlyStat {
    ...
    Process {
        'Calling method: Invoke-CpuHourlyStat' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v2/stat/cpu/hourly/{virtual_server_id}'
        if (!$VirtualServerId) {
            throw "Error! The required parameter `VirtualServerId` missing when calling cpuHourlyStat."
        }
        $LocalVarUri = $LocalVarUri.replace('{virtual_server_id}', [System.Web.HTTPUtility]::UrlEncode($VirtualServerId))
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "CpuHourlyStatResponse" `
                                -IsBodyNullable $false
...
#>
function Invoke-DriveDailyStat {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [Int32]
    ...
    Process {
        'Calling method: Invoke-DriveDailyStat' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v2/stat/drive/daily/{virtual_server_id}'
        if (!$VirtualServerId) {
            throw "Error! The required parameter `VirtualServerId` missing when calling driveDailyStat."
        }
        $LocalVarUri = $LocalVarUri.replace('{virtual_server_id}', [System.Web.HTTPUtility]::UrlEncode($VirtualServerId))
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "DriveDailyStatResponse" `
                                -IsBodyNullable $false
...
#>
function Invoke-DriveHourlyStat {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [Int32]
    ...
    Process {
        'Calling method: Invoke-DriveHourlyStat' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v2/stat/drive/hourly/{virtual_server_id}'
        if (!$VirtualServerId) {
            throw "Error! The required parameter `VirtualServerId` missing when calling driveHourlyStat."
        }
        $LocalVarUri = $LocalVarUri.replace('{virtual_server_id}', [System.Web.HTTPUtility]::UrlEncode($VirtualServerId))
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "DriveHourlyStatResponse" `
                                -IsBodyNullable $false
...
#>
function Invoke-NetworkDailyStat {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [Int32]
    ...
    Process {
        'Calling method: Invoke-NetworkDailyStat' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v2/stat/network/daily/{virtual_server_id}'
        if (!$VirtualServerId) {
            throw "Error! The required parameter `VirtualServerId` missing when calling networkDailyStat."
        }
        $LocalVarUri = $LocalVarUri.replace('{virtual_server_id}', [System.Web.HTTPUtility]::UrlEncode($VirtualServerId))
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "NetworkDailyStatResponse" `
                                -IsBodyNullable $false
...
#>
function Invoke-NetworkHourlyStat {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [Int32]
    ...
    Process {
        'Calling method: Invoke-NetworkHourlyStat' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v2/stat/network/hourly/{virtual_server_id}'
        if (!$VirtualServerId) {
            throw "Error! The required parameter `VirtualServerId` missing when calling networkHourlyStat."
        }
        $LocalVarUri = $LocalVarUri.replace('{virtual_server_id}', [System.Web.HTTPUtility]::UrlEncode($VirtualServerId))
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "NetworkHourlyStatResponse" `
                                -IsBodyNullable $false
