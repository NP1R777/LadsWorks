...
.PARAMETER Type
Тип запрашиваемого баланса. * `default` - Денежный баланс. * `bonus` - Количество бонусных баллов. * `partner` - Партнерские начисления.

.PARAMETER CurrencyId
В какой валюте получить значение баланса. * `1` - RUB * `3` - USD * `4` - EUR
...
function Invoke-BalanceGet {
    ...
    Process {
        'Calling method: Invoke-BalanceGet' | Write-Debug
