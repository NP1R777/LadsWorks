...
function Invoke-TokensCreate {
    ...
    Process {
        'Calling method: Invoke-TokensCreate' | Write-Debug
        ...
        $LocalVarUri = '/v2/tokens'

        $LocalVarBodyParameter = $TokenCreate | ConvertTo-Json -Depth 100
...
function Invoke-TokensGet {
    ...
    Process {
        'Calling method: Invoke-TokensGet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v2/tokens/{token_id}'
        if (!$TokenId) {
            throw "Error! The required parameter `TokenId` missing when calling tokensGet."
        }
        $LocalVarUri = $LocalVarUri.replace('{token_id}', [System.Web.HTTPUtility]::UrlEncode($TokenId))
...
function Invoke-TokensList {
    ...
    Process {
        'Calling method: Invoke-TokensList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Invoke-TokensPut {
    ...
    Process {
        'Calling method: Invoke-TokensPut' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v2/tokens/{token_id}'
        if (!$TokenId) {
            throw "Error! The required parameter `TokenId` missing when calling tokensPut."
        }
        $LocalVarUri = $LocalVarUri.replace('{token_id}', [System.Web.HTTPUtility]::UrlEncode($TokenId))
