...
function Invoke-ActionsGet {
    ...
    Process {
        'Calling method: Invoke-ActionsGet' | Write-Debug
        ...
        $LocalVarUri = '/v2/actions/{action_id}'
        if (!$ActionId) {
            throw "Error! The required parameter `ActionId` missing when calling actionsGet."
        }
        $LocalVarUri = $LocalVarUri.replace('{action_id}', [System.Web.HTTPUtility]::UrlEncode($ActionId))
...
function Invoke-ActionsList {
    ...
    Process {
        'Calling method: Invoke-ActionsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
