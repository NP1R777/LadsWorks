...
(function(root, factory) {
  ...
  describe('OSApi', function() {
    describe('osList', function() {
      it('should call osList successfully', function(done) {
        //uncomment below and update the code to test osList
        //instance.osList(function(error) {
