...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.SSHKeysApi();
  });
  ...
  describe('SSHKeysApi', function() {
    describe('sshKeysCreate', function() {
      it('should call sshKeysCreate successfully', function(done) {
        //uncomment below and update the code to test sshKeysCreate
        //instance.sshKeysCreate(function(error) {
    ...
    describe('sshKeysDelete', function() {
      it('should call sshKeysDelete successfully', function(done) {
        //uncomment below and update the code to test sshKeysDelete
        //instance.sshKeysDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('sshKeysList', function() {
      it('should call sshKeysList successfully', function(done) {
        //uncomment below and update the code to test sshKeysList
        //instance.sshKeysList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
