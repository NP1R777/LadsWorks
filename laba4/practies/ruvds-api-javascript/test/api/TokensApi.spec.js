...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.TokensApi();
  });
  ...
  describe('TokensApi', function() {
    ...
    describe('tokensPut', function() {
      it('should call tokensPut successfully', function(done) {
        //uncomment below and update the code to test tokensPut
        //instance.tokensPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
