...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.StatisticsApi();
  });
  ...
  describe('StatisticsApi', function() {
    describe('cpuDailyStat', function() {
      it('should call cpuDailyStat successfully', function(done) {
        //uncomment below and update the code to test cpuDailyStat
        //instance.cpuDailyStat(function(error) {
    ...
    describe('cpuHourlyStat', function() {
      it('should call cpuHourlyStat successfully', function(done) {
        //uncomment below and update the code to test cpuHourlyStat
        //instance.cpuHourlyStat(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('driveDailyStat', function() {
      it('should call driveDailyStat successfully', function(done) {
        //uncomment below and update the code to test driveDailyStat
        //instance.driveDailyStat(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('driveHourlyStat', function() {
      it('should call driveHourlyStat successfully', function(done) {
        //uncomment below and update the code to test driveHourlyStat
        //instance.driveHourlyStat(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('networkDailyStat', function() {
      it('should call networkDailyStat successfully', function(done) {
        //uncomment below and update the code to test networkDailyStat
        //instance.networkDailyStat(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('networkHourlyStat', function() {
      it('should call networkHourlyStat successfully', function(done) {
        //uncomment below and update the code to test networkHourlyStat
        //instance.networkHourlyStat(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
