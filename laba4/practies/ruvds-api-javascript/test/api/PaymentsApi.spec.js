...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.PaymentsApi();
  });
  ...
  describe('PaymentsApi', function() {
    describe('paymentsList', function() {
      it('should call paymentsList successfully', function(done) {
        //uncomment below and update the code to test paymentsList
        //instance.paymentsList(function(error) {
