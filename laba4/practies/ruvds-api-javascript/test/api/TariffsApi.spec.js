...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.TariffsApi();
  });
  ...
  describe('TariffsApi', function() {
    describe('tariffsList', function() {
      it('should call tariffsList successfully', function(done) {
        //uncomment below and update the code to test tariffsList
        //instance.tariffsList(function(error) {
