...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.DatacentersApi();
  });
  ...
  describe('DatacentersApi', function() {
    describe('datacentersList', function() {
      it('should call datacentersList successfully', function(done) {
        //uncomment below and update the code to test datacentersList
        //instance.datacentersList(function(error) {
