...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.ServerPaidTill();
  });
  ...
  describe('ServerPaidTill', function() {
    it('should create an instance of ServerPaidTill', function() {
      // uncomment below and update the code to test ServerPaidTill
      //var instance = new RuvdsApi.ServerPaidTill();
      //expect(instance).to.be.a(RuvdsApi.ServerPaidTill);
    });
    ...
    it('should have the property paidTill (base name: "paid_till")', function() {
      // uncomment below and update the code to test the property paidTill
      //var instance = new RuvdsApi.ServerPaidTill();
      //expect(instance).to.be();
    });
