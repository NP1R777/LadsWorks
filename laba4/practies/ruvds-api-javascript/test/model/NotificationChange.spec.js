...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.NotificationChange();
  });
  ...
  describe('NotificationChange', function() {
    it('should create an instance of NotificationChange', function() {
      // uncomment below and update the code to test NotificationChange
      //var instance = new RuvdsApi.NotificationChange();
      //expect(instance).to.be.a(RuvdsApi.NotificationChange);
    });
