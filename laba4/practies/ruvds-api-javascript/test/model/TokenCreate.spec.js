...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.TokenCreate();
  });
  ...
  describe('TokenCreate', function() {
    it('should create an instance of TokenCreate', function() {
      // uncomment below and update the code to test TokenCreate
      //var instance = new RuvdsApi.TokenCreate();
      //expect(instance).to.be.a(RuvdsApi.TokenCreate);
    });
    ...
    it('should have the property tokenRole (base name: "token_role")', function() {
      // uncomment below and update the code to test the property tokenRole
      //var instance = new RuvdsApi.TokenCreate();
      //expect(instance).to.be();
    });

    it('should have the property tokenExpiry (base name: "token_expiry")', function() {
