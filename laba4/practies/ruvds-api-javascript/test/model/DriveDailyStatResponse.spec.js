...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.DriveDailyStatResponse();
  });
  ...
  describe('DriveDailyStatResponse', function() {
    it('should create an instance of DriveDailyStatResponse', function() {
      // uncomment below and update the code to test DriveDailyStatResponse
      //var instance = new RuvdsApi.DriveDailyStatResponse();
      //expect(instance).to.be.a(RuvdsApi.DriveDailyStatResponse);
    });
