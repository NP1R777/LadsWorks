...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.Datacenter();
  });
  ...
  describe('Datacenter', function() {
    it('should create an instance of Datacenter', function() {
      ...
      //var instance = new RuvdsApi.Datacenter();
      //expect(instance).to.be.a(RuvdsApi.Datacenter);
    });
    ...
    it('should have the property vpsTariffs (base name: "vps_tariffs")', function() {
      // uncomment below and update the code to test the property vpsTariffs
      //var instance = new RuvdsApi.Datacenter();
      //expect(instance).to.be();
    });

    it('should have the property driveTariffs (base name: "drive_tariffs")', function() {
      // uncomment below and update the code to test the property driveTariffs
      //var instance = new RuvdsApi.Datacenter();
      //expect(instance).to.be();
    });

    it('should have the property additionalDriveTariffs (base name: "additional_drive_tariffs")', function() {
      // uncomment below and update the code to test the property additionalDriveTariffs
      //var instance = new RuvdsApi.Datacenter();
      //expect(instance).to.be();
    });

    it('should have the property additionalServiceTariffs (base name: "additional_service_tariffs")', function() {
      // uncomment below and update the code to test the property additionalServiceTariffs
      //var instance = new RuvdsApi.Datacenter();
      //expect(instance).to.be();
    });
