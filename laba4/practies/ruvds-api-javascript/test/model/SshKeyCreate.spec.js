...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.SshKeyCreate();
  });
  ...
  describe('SshKeyCreate', function() {
    it('should create an instance of SshKeyCreate', function() {
      // uncomment below and update the code to test SshKeyCreate
      //var instance = new RuvdsApi.SshKeyCreate();
      //expect(instance).to.be.a(RuvdsApi.SshKeyCreate);
    });
