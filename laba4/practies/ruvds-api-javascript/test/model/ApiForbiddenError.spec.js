...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.ApiForbiddenError();
  });
  ...
  describe('ApiForbiddenError', function() {
    it('should create an instance of ApiForbiddenError', function() {
      // uncomment below and update the code to test ApiForbiddenError
      //var instance = new RuvdsApi.ApiForbiddenError();
      //expect(instance).to.be.a(RuvdsApi.ApiForbiddenError);
    });
