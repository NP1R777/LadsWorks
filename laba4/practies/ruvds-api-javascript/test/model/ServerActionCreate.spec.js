...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.ServerActionCreate();
  });
  ...
  describe('ServerActionCreate', function() {
    it('should create an instance of ServerActionCreate', function() {
      // uncomment below and update the code to test ServerActionCreate
      //var instance = new RuvdsApi.ServerActionCreate();
      //expect(instance).to.be.a(RuvdsApi.ServerActionCreate);
    });
