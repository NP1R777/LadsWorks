...
(function(root, factory) {
  ...
  describe('Payment', function() {
    it('should create an instance of Payment', function() {
      ...
      //var instance = new RuvdsApi.Payment();
      //expect(instance).to.be.a(RuvdsApi.Payment);
    });
    ...
    it('should have the property paySource (base name: "pay_source")', function() {
      // uncomment below and update the code to test the property paySource
      //var instance = new RuvdsApi.Payment();
      //expect(instance).to.be();
    });
