...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.ActionError();
  });
  ...
  describe('ActionError', function() {
    it('should create an instance of ActionError', function() {
      // uncomment below and update the code to test ActionError
      //var instance = new RuvdsApi.ActionError();
      //expect(instance).to.be.a(RuvdsApi.ActionError);
    });
