...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.CpuHourlyStatResponse();
  });
  ...
  describe('CpuHourlyStatResponse', function() {
    it('should create an instance of CpuHourlyStatResponse', function() {
      // uncomment below and update the code to test CpuHourlyStatResponse
      //var instance = new RuvdsApi.CpuHourlyStatResponse();
      //expect(instance).to.be.a(RuvdsApi.CpuHourlyStatResponse);
    });

    it('should have the property cpuStat (base name: "cpu_stat")', function() {
      // uncomment below and update the code to test the property cpuStat
      //var instance = new RuvdsApi.CpuHourlyStatResponse();
