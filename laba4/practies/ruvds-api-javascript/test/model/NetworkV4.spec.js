...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.NetworkV4();
  });
  ...
  describe('NetworkV4', function() {
    it('should create an instance of NetworkV4', function() {
      // uncomment below and update the code to test NetworkV4
      //var instance = new RuvdsApi.NetworkV4();
      //expect(instance).to.be.a(RuvdsApi.NetworkV4);
    });
