...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.ServerCreateResponse();
  });
  ...
  describe('ServerCreateResponse', function() {
    it('should create an instance of ServerCreateResponse', function() {
      // uncomment below and update the code to test ServerCreateResponse
      //var instance = new RuvdsApi.ServerCreateResponse();
      //expect(instance).to.be.a(RuvdsApi.ServerCreateResponse);
    });
    ...
    it('should have the property costRub (base name: "cost_rub")', function() {
      // uncomment below and update the code to test the property costRub
      //var instance = new RuvdsApi.ServerCreateResponse();
      //expect(instance).to.be();
    });
