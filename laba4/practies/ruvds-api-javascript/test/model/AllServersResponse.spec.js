...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.AllServersResponse();
  });
  ...
  describe('AllServersResponse', function() {
    it('should create an instance of AllServersResponse', function() {
      // uncomment below and update the code to test AllServersResponse
      //var instance = new RuvdsApi.AllServersResponse();
      //expect(instance).to.be.a(RuvdsApi.AllServersResponse);
    });
