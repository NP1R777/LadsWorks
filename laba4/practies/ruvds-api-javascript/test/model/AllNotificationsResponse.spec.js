...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.AllNotificationsResponse();
  });
  ...
  describe('AllNotificationsResponse', function() {
    it('should create an instance of AllNotificationsResponse', function() {
      // uncomment below and update the code to test AllNotificationsResponse
      //var instance = new RuvdsApi.AllNotificationsResponse();
      //expect(instance).to.be.a(RuvdsApi.AllNotificationsResponse);
    });
