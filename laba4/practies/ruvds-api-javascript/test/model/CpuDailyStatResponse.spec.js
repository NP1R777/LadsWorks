...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.CpuDailyStatResponse();
  });
  ...
  describe('CpuDailyStatResponse', function() {
    it('should create an instance of CpuDailyStatResponse', function() {
      // uncomment below and update the code to test CpuDailyStatResponse
      //var instance = new RuvdsApi.CpuDailyStatResponse();
      //expect(instance).to.be.a(RuvdsApi.CpuDailyStatResponse);
    });
