...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.AllTariffsResponse();
  });
  ...
  describe('AllTariffsResponse', function() {
    it('should create an instance of AllTariffsResponse', function() {
      // uncomment below and update the code to test AllTariffsResponse
      //var instance = new RuvdsApi.AllTariffsResponse();
      //expect(instance).to.be.a(RuvdsApi.AllTariffsResponse);
    });
    ...
    it('should have the property additionalService (base name: "additional_service")', function() {
