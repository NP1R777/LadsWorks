...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.ServerChange();
  });
  ...
  describe('ServerChange', function() {
    it('should create an instance of ServerChange', function() {
      // uncomment below and update the code to test ServerChange
      //var instance = new RuvdsApi.ServerChange();
      //expect(instance).to.be.a(RuvdsApi.ServerChange);
    });
