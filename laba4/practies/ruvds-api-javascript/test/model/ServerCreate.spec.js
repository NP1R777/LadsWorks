...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.ServerCreate();
  });
  ...
  describe('ServerCreate', function() {
    it('should create an instance of ServerCreate', function() {
      // uncomment below and update the code to test ServerCreate
      //var instance = new RuvdsApi.ServerCreate();
      //expect(instance).to.be.a(RuvdsApi.ServerCreate);
    });
    ...
    it('should have the property tariffId (base name: "tariff_id")', function() {
      // uncomment below and update the code to test the property tariffId
      //var instance = new RuvdsApi.ServerCreate();
      //expect(instance).to.be();
    });

    it('should have the property osId (base name: "os_id")', function() {
    ...
    it('should have the property vram (base name: "vram")', function() {
      // uncomment below and update the code to test the property vram
      //var instance = new RuvdsApi.ServerCreate();
      //expect(instance).to.be();
    });
    ...
    it('should have the property driveTariffId (base name: "drive_tariff_id")', function() {
      // uncomment below and update the code to test the property driveTariffId
      //var instance = new RuvdsApi.ServerCreate();
      //expect(instance).to.be();
    });

    it('should have the property additionalDrive (base name: "additional_drive")', function() {
      // uncomment below and update the code to test the property additionalDrive
      //var instance = new RuvdsApi.ServerCreate();
      //expect(instance).to.be();
    });

    it('should have the property additionalDriveTariffId (base name: "additional_drive_tariff_id")', function() {
      // uncomment below and update the code to test the property additionalDriveTariffId
      //var instance = new RuvdsApi.ServerCreate();
      //expect(instance).to.be();
    });
    ...
    it('should have the property ddosProtection (base name: "ddos_protection")', function() {
      // uncomment below and update the code to test the property ddosProtection
      //var instance = new RuvdsApi.ServerCreate();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sshKeyId (base name: "ssh_key_id")', function() {
      // uncomment below and update the code to test the property sshKeyId
      //var instance = new RuvdsApi.ServerCreate();
      //expect(instance).to.be();
    });

    it('should have the property computerName (base name: "computer_name")', function() {
