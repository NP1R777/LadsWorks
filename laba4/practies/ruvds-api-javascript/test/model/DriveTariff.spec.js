...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.DriveTariff();
  });
  ...
  describe('DriveTariff', function() {
    it('should create an instance of DriveTariff', function() {
      // uncomment below and update the code to test DriveTariff
      //var instance = new RuvdsApi.DriveTariff();
      //expect(instance).to.be.a(RuvdsApi.DriveTariff);
    });
