...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.AllSshKeys();
  });
  ...
  describe('AllSshKeys', function() {
    it('should create an instance of AllSshKeys', function() {
      // uncomment below and update the code to test AllSshKeys
      //var instance = new RuvdsApi.AllSshKeys();
      //expect(instance).to.be.a(RuvdsApi.AllSshKeys);
    });
