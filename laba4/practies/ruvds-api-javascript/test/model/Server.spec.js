...
(function(root, factory) {
  ...
  describe('Server', function() {
    it('should create an instance of Server', function() {
      ...
      //var instance = new RuvdsApi.Server();
      //expect(instance).to.be.a(RuvdsApi.Server);
    });

    it('should have the property virtualServerId (base name: "virtual_server_id")', function() {
      // uncomment below and update the code to test the property virtualServerId
      //var instance = new RuvdsApi.Server();
    ...
    it('should have the property createProgress (base name: "create_progress")', function() {
      // uncomment below and update the code to test the property createProgress
      //var instance = new RuvdsApi.Server();
      //expect(instance).to.be();
    });
