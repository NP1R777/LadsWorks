...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.AllTemplatesResponse();
  });
  ...
  describe('AllTemplatesResponse', function() {
    it('should create an instance of AllTemplatesResponse', function() {
      // uncomment below and update the code to test AllTemplatesResponse
      //var instance = new RuvdsApi.AllTemplatesResponse();
      //expect(instance).to.be.a(RuvdsApi.AllTemplatesResponse);
    });
