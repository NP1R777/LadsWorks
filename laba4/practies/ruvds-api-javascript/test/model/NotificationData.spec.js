...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.NotificationData();
  });
  ...
  describe('NotificationData', function() {
    it('should create an instance of NotificationData', function() {
      // uncomment below and update the code to test NotificationData
      //var instance = new RuvdsApi.NotificationData();
      //expect(instance).to.be.a(RuvdsApi.NotificationData);
    });
    ...
    it('should have the property mustPayTill (base name: "must_pay_till")', function() {
      // uncomment below and update the code to test the property mustPayTill
      //var instance = new RuvdsApi.NotificationData();
      //expect(instance).to.be();
    });

    it('should have the property costOld (base name: "cost_old")', function() {
      // uncomment below and update the code to test the property costOld
      //var instance = new RuvdsApi.NotificationData();
      //expect(instance).to.be();
    });

    it('should have the property costNew (base name: "cost_new")', function() {
      // uncomment below and update the code to test the property costNew
      //var instance = new RuvdsApi.NotificationData();
      //expect(instance).to.be();
    });
