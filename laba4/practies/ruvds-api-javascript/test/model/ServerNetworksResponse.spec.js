...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.ServerNetworksResponse();
  });
  ...
  describe('ServerNetworksResponse', function() {
    it('should create an instance of ServerNetworksResponse', function() {
      // uncomment below and update the code to test ServerNetworksResponse
      //var instance = new RuvdsApi.ServerNetworksResponse();
      //expect(instance).to.be.a(RuvdsApi.ServerNetworksResponse);
    });

    it('should have the property v4 (base name: "v4")', function() {
      // uncomment below and update the code to test the property v4
      //var instance = new RuvdsApi.ServerNetworksResponse();
