...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.NetworkStat();
  });
  ...
  describe('NetworkStat', function() {
    it('should create an instance of NetworkStat', function() {
      // uncomment below and update the code to test NetworkStat
      //var instance = new RuvdsApi.NetworkStat();
      //expect(instance).to.be.a(RuvdsApi.NetworkStat);
    });

    it('should have the property addDt (base name: "add_dt")', function() {
      // uncomment below and update the code to test the property addDt
      //var instance = new RuvdsApi.NetworkStat();
      //expect(instance).to.be();
    });

    it('should have the property inboundPps (base name: "inbound_pps")', function() {
      // uncomment below and update the code to test the property inboundPps
      //var instance = new RuvdsApi.NetworkStat();
      //expect(instance).to.be();
    });

    it('should have the property outboundPps (base name: "outbound_pps")', function() {
      // uncomment below and update the code to test the property outboundPps
      //var instance = new RuvdsApi.NetworkStat();
      //expect(instance).to.be();
    });

    it('should have the property inboundBps (base name: "inbound_bps")', function() {
      // uncomment below and update the code to test the property inboundBps
      //var instance = new RuvdsApi.NetworkStat();
      //expect(instance).to.be();
    });

    it('should have the property outboundBps (base name: "outbound_bps")', function() {
      // uncomment below and update the code to test the property outboundBps
      //var instance = new RuvdsApi.NetworkStat();
      //expect(instance).to.be();
    });
