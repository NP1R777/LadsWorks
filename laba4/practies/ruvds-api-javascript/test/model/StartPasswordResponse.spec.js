...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.StartPasswordResponse();
  });
  ...
  describe('StartPasswordResponse', function() {
    it('should create an instance of StartPasswordResponse', function() {
      // uncomment below and update the code to test StartPasswordResponse
      //var instance = new RuvdsApi.StartPasswordResponse();
      //expect(instance).to.be.a(RuvdsApi.StartPasswordResponse);
    });
    ...
    it('should have the property passwordFormat (base name: "password_format")', function() {
      // uncomment below and update the code to test the property passwordFormat
      //var instance = new RuvdsApi.StartPasswordResponse();
      //expect(instance).to.be();
    });
