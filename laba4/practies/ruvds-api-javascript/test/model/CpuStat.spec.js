...
(function(root, factory) {
  ...
  describe('CpuStat', function() {
    it('should create an instance of CpuStat', function() {
      // uncomment below and update the code to test CpuStat
      //var instance = new RuvdsApi.CpuStat();
      //expect(instance).to.be.a(RuvdsApi.CpuStat);
    });
