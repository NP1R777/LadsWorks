...
(function(root, factory) {
  ...
  describe('PaymentPeriod', function() {
    it('should create an instance of PaymentPeriod', function() {
      // uncomment below and update the code to test PaymentPeriod
      //var instance = new RuvdsApi.PaymentPeriod();
      //expect(instance).to.be.a(RuvdsApi.PaymentPeriod);
    });
