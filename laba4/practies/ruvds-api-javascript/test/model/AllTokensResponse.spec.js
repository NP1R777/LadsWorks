...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.AllTokensResponse();
  });
  ...
  describe('AllTokensResponse', function() {
    it('should create an instance of AllTokensResponse', function() {
      // uncomment below and update the code to test AllTokensResponse
      //var instance = new RuvdsApi.AllTokensResponse();
      //expect(instance).to.be.a(RuvdsApi.AllTokensResponse);
    });
