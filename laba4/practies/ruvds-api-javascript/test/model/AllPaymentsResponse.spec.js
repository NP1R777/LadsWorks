...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.AllPaymentsResponse();
  });
  ...
  describe('AllPaymentsResponse', function() {
    it('should create an instance of AllPaymentsResponse', function() {
      // uncomment below and update the code to test AllPaymentsResponse
      //var instance = new RuvdsApi.AllPaymentsResponse();
      //expect(instance).to.be.a(RuvdsApi.AllPaymentsResponse);
    });
