...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.DriveStat();
  });
  ...
  describe('DriveStat', function() {
    it('should create an instance of DriveStat', function() {
      // uncomment below and update the code to test DriveStat
      //var instance = new RuvdsApi.DriveStat();
      //expect(instance).to.be.a(RuvdsApi.DriveStat);
    });
    ...
    it('should have the property readIops (base name: "read_iops")', function() {
      // uncomment below and update the code to test the property readIops
      //var instance = new RuvdsApi.DriveStat();
      //expect(instance).to.be();
    });

    it('should have the property writeIops (base name: "write_iops")', function() {
