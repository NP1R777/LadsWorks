...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.AllDatacentersResponse();
  });
  ...
  describe('AllDatacentersResponse', function() {
    it('should create an instance of AllDatacentersResponse', function() {
      // uncomment below and update the code to test AllDatacentersResponse
      //var instance = new RuvdsApi.AllDatacentersResponse();
      //expect(instance).to.be.a(RuvdsApi.AllDatacentersResponse);
    });
