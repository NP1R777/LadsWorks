...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.AllActionsResponse();
  });
  ...
  describe('AllActionsResponse', function() {
    it('should create an instance of AllActionsResponse', function() {
      // uncomment below and update the code to test AllActionsResponse
      //var instance = new RuvdsApi.AllActionsResponse();
      //expect(instance).to.be.a(RuvdsApi.AllActionsResponse);
    });
