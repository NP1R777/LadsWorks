...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.StartPassword();
  });
  ...
  describe('StartPassword', function() {
    it('should create an instance of StartPassword', function() {
      // uncomment below and update the code to test StartPassword
      //var instance = new RuvdsApi.StartPassword();
      //expect(instance).to.be.a(RuvdsApi.StartPassword);
    });

    it('should have the property accountPassword (base name: "account_password")', function() {
