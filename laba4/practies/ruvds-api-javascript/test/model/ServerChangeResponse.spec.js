...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.ServerChangeResponse();
  });
  ...
  describe('ServerChangeResponse', function() {
    it('should create an instance of ServerChangeResponse', function() {
      // uncomment below and update the code to test ServerChangeResponse
      //var instance = new RuvdsApi.ServerChangeResponse();
      //expect(instance).to.be.a(RuvdsApi.ServerChangeResponse);
    });
