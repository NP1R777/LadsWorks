...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.AllOsResponse();
  });
  ...
  describe('AllOsResponse', function() {
    it('should create an instance of AllOsResponse', function() {
      // uncomment below and update the code to test AllOsResponse
      //var instance = new RuvdsApi.AllOsResponse();
      //expect(instance).to.be.a(RuvdsApi.AllOsResponse);
    });
