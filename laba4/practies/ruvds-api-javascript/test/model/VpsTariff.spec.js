...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.VpsTariff();
  });
  ...
  describe('VpsTariff', function() {
    it('should create an instance of VpsTariff', function() {
      // uncomment below and update the code to test VpsTariff
      //var instance = new RuvdsApi.VpsTariff();
      //expect(instance).to.be.a(RuvdsApi.VpsTariff);
    });
