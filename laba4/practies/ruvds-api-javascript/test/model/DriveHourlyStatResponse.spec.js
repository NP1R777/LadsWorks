...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.DriveHourlyStatResponse();
  });
  ...
  describe('DriveHourlyStatResponse', function() {
    it('should create an instance of DriveHourlyStatResponse', function() {
      // uncomment below and update the code to test DriveHourlyStatResponse
      //var instance = new RuvdsApi.DriveHourlyStatResponse();
      //expect(instance).to.be.a(RuvdsApi.DriveHourlyStatResponse);
    });

    it('should have the property driveStat (base name: "drive_stat")', function() {
      // uncomment below and update the code to test the property driveStat
      //var instance = new RuvdsApi.DriveHourlyStatResponse();
