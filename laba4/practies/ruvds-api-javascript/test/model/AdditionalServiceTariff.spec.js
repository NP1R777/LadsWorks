...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.AdditionalServiceTariff();
  });
  ...
  describe('AdditionalServiceTariff', function() {
    it('should create an instance of AdditionalServiceTariff', function() {
      // uncomment below and update the code to test AdditionalServiceTariff
      //var instance = new RuvdsApi.AdditionalServiceTariff();
      //expect(instance).to.be.a(RuvdsApi.AdditionalServiceTariff);
    });
