...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.ServerPowerState();
  });
  ...
  describe('ServerPowerState', function() {
    it('should create an instance of ServerPowerState', function() {
      // uncomment below and update the code to test ServerPowerState
      //var instance = new RuvdsApi.ServerPowerState();
      //expect(instance).to.be.a(RuvdsApi.ServerPowerState);
    });
