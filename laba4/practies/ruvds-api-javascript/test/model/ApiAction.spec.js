...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.ApiAction();
  });
  ...
  describe('ApiAction', function() {
    it('should create an instance of ApiAction', function() {
      // uncomment below and update the code to test ApiAction
      //var instance = new RuvdsApi.ApiAction();
      //expect(instance).to.be.a(RuvdsApi.ApiAction);
    });
    ...
    it('should have the property actionError (base name: "action_error")', function() {
      // uncomment below and update the code to test the property actionError
      //var instance = new RuvdsApi.ApiAction();
      //expect(instance).to.be();
    });
