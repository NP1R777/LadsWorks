...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.NetworkDailyStatResponse();
  });
  ...
  describe('NetworkDailyStatResponse', function() {
    it('should create an instance of NetworkDailyStatResponse', function() {
      // uncomment below and update the code to test NetworkDailyStatResponse
      //var instance = new RuvdsApi.NetworkDailyStatResponse();
      //expect(instance).to.be.a(RuvdsApi.NetworkDailyStatResponse);
    });
