...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.NetworkHourlyStatResponse();
  });
  ...
  describe('NetworkHourlyStatResponse', function() {
    it('should create an instance of NetworkHourlyStatResponse', function() {
      // uncomment below and update the code to test NetworkHourlyStatResponse
      //var instance = new RuvdsApi.NetworkHourlyStatResponse();
      //expect(instance).to.be.a(RuvdsApi.NetworkHourlyStatResponse);
    });

    it('should have the property networkStat (base name: "network_stat")', function() {
      // uncomment below and update the code to test the property networkStat
      //var instance = new RuvdsApi.NetworkHourlyStatResponse();
