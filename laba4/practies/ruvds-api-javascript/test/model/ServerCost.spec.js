...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.ServerCost();
  });
  ...
  describe('ServerCost', function() {
    it('should create an instance of ServerCost', function() {
      // uncomment below and update the code to test ServerCost
      //var instance = new RuvdsApi.ServerCost();
      //expect(instance).to.be.a(RuvdsApi.ServerCost);
    });
