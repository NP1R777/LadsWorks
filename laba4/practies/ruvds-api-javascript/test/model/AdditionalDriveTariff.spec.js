...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RuvdsApi.AdditionalDriveTariff();
  });
  ...
  describe('AdditionalDriveTariff', function() {
    it('should create an instance of AdditionalDriveTariff', function() {
      // uncomment below and update the code to test AdditionalDriveTariff
      //var instance = new RuvdsApi.AdditionalDriveTariff();
      //expect(instance).to.be.a(RuvdsApi.AdditionalDriveTariff);
    });
