...
/**
 * The AllNotificationsResponse model module.
 * @module model/AllNotificationsResponse
 * @version 2.16
 */
class AllNotificationsResponse {
    /**
     * Constructs a new <code>AllNotificationsResponse</code>.
     * @alias module:model/AllNotificationsResponse
     * @param notifications {Array.<module:model/Notification>} 
     * @param pagination {module:model/Pagination} 
     */
    constructor(notifications, pagination) { 
        
        AllNotificationsResponse.initialize(this, notifications, pagination);
    }
     ...
     */
    static initialize(obj, notifications, pagination) { 
        obj['notifications'] = notifications;
        obj['pagination'] = pagination;
    }

    /**
     * Constructs a <code>AllNotificationsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AllNotificationsResponse} obj Optional instance to populate.
     * @return {module:model/AllNotificationsResponse} The populated <code>AllNotificationsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllNotificationsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AllNotificationsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AllNotificationsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AllNotificationsResponse.RequiredProperties) {
...
AllNotificationsResponse.RequiredProperties = ["notifications", "pagination"];

/**
 * @member {Array.<module:model/Notification>} notifications
 */
AllNotificationsResponse.prototype['notifications'] = undefined;

/**
 * @member {module:model/Pagination} pagination
 */
AllNotificationsResponse.prototype['pagination'] = undefined;
