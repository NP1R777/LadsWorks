...
class Template {
     ...
     * @param templateId {String} ID шаблона виртуального сервера.
     * @param name {String} Имя шаблона.
     */
    constructor(templateId, name) { 
        
        Template.initialize(this, templateId, name);
    }
     ...
     */
    static initialize(obj, templateId, name) { 
...
Template.RequiredProperties = ["template_id", "name"];

/**
 * ID шаблона виртуального сервера.
 * @member {String} template_id
 */
Template.prototype['template_id'] = undefined;
