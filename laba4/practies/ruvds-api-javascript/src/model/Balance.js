...
class Balance {
     ...
     * @param amount {Number} Баланс в валюте, указанной в поле `currency`.
     * @param currency {module:model/Currency} 
     * @param type {module:model/Type} 
     */
    constructor(amount, currency, type) { 
        
        Balance.initialize(this, amount, currency, type);
    }
...
Balance.RequiredProperties = ["amount", "currency", "type"];

/**
 * Баланс в валюте, указанной в поле `currency`.
