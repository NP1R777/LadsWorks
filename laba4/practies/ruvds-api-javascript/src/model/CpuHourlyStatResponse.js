...
/**
 * The CpuHourlyStatResponse model module.
 * @module model/CpuHourlyStatResponse
 * @version 2.16
 */
class CpuHourlyStatResponse {
    /**
     * Constructs a new <code>CpuHourlyStatResponse</code>.
     * @alias module:model/CpuHourlyStatResponse
     * @param cpuStat {Array.<module:model/CpuStat>} 
     */
    constructor(cpuStat) { 
        
        CpuHourlyStatResponse.initialize(this, cpuStat);
    }
     ...
     */
    static initialize(obj, cpuStat) { 
        obj['cpu_stat'] = cpuStat;
    }

    /**
     * Constructs a <code>CpuHourlyStatResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CpuHourlyStatResponse} obj Optional instance to populate.
     * @return {module:model/CpuHourlyStatResponse} The populated <code>CpuHourlyStatResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CpuHourlyStatResponse();

            if (data.hasOwnProperty('cpu_stat')) {
                obj['cpu_stat'] = ApiClient.convertToType(data['cpu_stat'], [CpuStat]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CpuHourlyStatResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CpuHourlyStatResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CpuHourlyStatResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        if (data['cpu_stat']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['cpu_stat'])) {
                throw new Error("Expected the field `cpu_stat` to be an array in the JSON data but got " + data['cpu_stat']);
            }
            // validate the optional field `cpu_stat` (array)
            for (const item of data['cpu_stat']) {
                CpuStat.validateJSON(item);
            };
        }
...
CpuHourlyStatResponse.RequiredProperties = ["cpu_stat"];

/**
 * @member {Array.<module:model/CpuStat>} cpu_stat
 */
CpuHourlyStatResponse.prototype['cpu_stat'] = undefined;
...
export default CpuHourlyStatResponse;
