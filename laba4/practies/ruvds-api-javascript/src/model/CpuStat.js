...
/**
 * The CpuStat model module.
 * @module model/CpuStat
 * @version 2.16
 */
class CpuStat {
    /**
     * Constructs a new <code>CpuStat</code>.
     * @alias module:model/CpuStat
     * @param addDt {Date} Время формирования статистики.
     * @param cpuUsage {Number} Среднее использование CPU в процентах.
     */
    constructor(addDt, cpuUsage) { 
        
        CpuStat.initialize(this, addDt, cpuUsage);
    }
     ...
     */
    static initialize(obj, addDt, cpuUsage) { 
        obj['add_dt'] = addDt;
        obj['cpu_usage'] = cpuUsage;
    }

    /**
     * Constructs a <code>CpuStat</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CpuStat} obj Optional instance to populate.
     * @return {module:model/CpuStat} The populated <code>CpuStat</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>CpuStat</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CpuStat</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CpuStat.RequiredProperties) {
...
CpuStat.RequiredProperties = ["add_dt", "cpu_usage"];

/**
 * Время формирования статистики.
 * @member {Date} add_dt
 */
CpuStat.prototype['add_dt'] = undefined;

/**
 * Среднее использование CPU в процентах.
 * @member {Number} cpu_usage
 */
CpuStat.prototype['cpu_usage'] = undefined;
