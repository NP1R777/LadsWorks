...
/**
 * The AllPaymentsResponse model module.
 * @module model/AllPaymentsResponse
 * @version 2.16
 */
class AllPaymentsResponse {
    /**
     * Constructs a new <code>AllPaymentsResponse</code>.
     * @alias module:model/AllPaymentsResponse
     * @param payments {Array.<module:model/Payment>} 
     * @param pagination {module:model/Pagination} 
     */
    constructor(payments, pagination) { 
        
        AllPaymentsResponse.initialize(this, payments, pagination);
    }
     ...
     */
    static initialize(obj, payments, pagination) { 
        obj['payments'] = payments;
        obj['pagination'] = pagination;
    }

    /**
     * Constructs a <code>AllPaymentsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AllPaymentsResponse} obj Optional instance to populate.
     * @return {module:model/AllPaymentsResponse} The populated <code>AllPaymentsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllPaymentsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AllPaymentsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AllPaymentsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AllPaymentsResponse.RequiredProperties) {
...
AllPaymentsResponse.RequiredProperties = ["payments", "pagination"];

/**
 * @member {Array.<module:model/Payment>} payments
 */
AllPaymentsResponse.prototype['payments'] = undefined;

/**
 * @member {module:model/Pagination} pagination
 */
AllPaymentsResponse.prototype['pagination'] = undefined;
...
export default AllPaymentsResponse;
