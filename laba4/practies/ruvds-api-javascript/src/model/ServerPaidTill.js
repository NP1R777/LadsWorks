...
/**
 * The ServerPaidTill model module.
 * @module model/ServerPaidTill
 * @version 2.16
 */
class ServerPaidTill {
    /**
     * Constructs a new <code>ServerPaidTill</code>.
     * @alias module:model/ServerPaidTill
     */
    constructor() { 
        
        ServerPaidTill.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServerPaidTill</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServerPaidTill} obj Optional instance to populate.
     * @return {module:model/ServerPaidTill} The populated <code>ServerPaidTill</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServerPaidTill();
            ...
            if (data.hasOwnProperty('paid_till')) {
                obj['paid_till'] = ApiClient.convertToType(data['paid_till'], 'Date');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ServerPaidTill</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServerPaidTill</code>.
     */
 ...
 */
ServerPaidTill.prototype['virtual_server_id'] = undefined;

/**
 * Дата и время UTC до которой оплачен сервер.
 * @member {Date} paid_till
 */
ServerPaidTill.prototype['paid_till'] = undefined;
