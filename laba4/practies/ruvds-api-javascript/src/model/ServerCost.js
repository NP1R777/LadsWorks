...
/**
 * The ServerCost model module.
 * @module model/ServerCost
 * @version 2.16
 */
class ServerCost {
    /**
     * Constructs a new <code>ServerCost</code>.
     * @alias module:model/ServerCost
     * @param costRub {Number} Стоимость сервера в рублях за указанный `payment_period`
     * @param paymentPeriod {module:model/PaymentPeriod} 
     */
    constructor(costRub, paymentPeriod) { 
        
        ServerCost.initialize(this, costRub, paymentPeriod);
    }
     ...
     */
    static initialize(obj, costRub, paymentPeriod) { 
        obj['cost_rub'] = costRub;
        obj['payment_period'] = paymentPeriod;
    }

    /**
     * Constructs a <code>ServerCost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServerCost} obj Optional instance to populate.
     * @return {module:model/ServerCost} The populated <code>ServerCost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServerCost();
    ...
    /**
     * Validates the JSON data with respect to <code>ServerCost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServerCost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServerCost.RequiredProperties) {
...
ServerCost.RequiredProperties = ["cost_rub", "payment_period"];

/**
 * Стоимость сервера в рублях за указанный `payment_period`
 * @member {Number} cost_rub
 */
ServerCost.prototype['cost_rub'] = undefined;

/**
 * @member {module:model/PaymentPeriod} payment_period
 */
ServerCost.prototype['payment_period'] = undefined;
