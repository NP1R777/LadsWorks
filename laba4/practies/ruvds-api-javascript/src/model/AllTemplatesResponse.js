...
/**
 * The AllTemplatesResponse model module.
 * @module model/AllTemplatesResponse
 * @version 2.16
 */
class AllTemplatesResponse {
    /**
     * Constructs a new <code>AllTemplatesResponse</code>.
     * @alias module:model/AllTemplatesResponse
     * @param templates {Array.<module:model/Template>} 
     */
    constructor(templates) { 
        
        AllTemplatesResponse.initialize(this, templates);
    }
    ...
    /**
     * Constructs a <code>AllTemplatesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AllTemplatesResponse} obj Optional instance to populate.
     * @return {module:model/AllTemplatesResponse} The populated <code>AllTemplatesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllTemplatesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AllTemplatesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AllTemplatesResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AllTemplatesResponse.RequiredProperties) {
...
AllTemplatesResponse.RequiredProperties = ["templates"];

/**
 * @member {Array.<module:model/Template>} templates
 */
AllTemplatesResponse.prototype['templates'] = undefined;
...
export default AllTemplatesResponse;
