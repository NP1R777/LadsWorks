...
/**
 * The VpsTariff model module.
 * @module model/VpsTariff
 * @version 2.16
 */
class VpsTariff {
    /**
     * Constructs a new <code>VpsTariff</code>.
     * @alias module:model/VpsTariff
     * @param id {Number} ID тарифного плана виртуального сервера.
     * @param name {String} Название тарифа.
     * @param cpu {Number} Цена RUB за виртуальное ядро CPU.
     * @param ram {Number} Цена RUB за 1 Гб оперативной памяти.
     * @param vram {Number} Цена RUB за 1 Мб видео памяти.
     * @param ip {Number} Цена за 1 дополнительный IP адрес.
     * @param isActive {Boolean} Тариф активен.
     */
    constructor(id, name, cpu, ram, vram, ip, isActive) { 
        
        VpsTariff.initialize(this, id, name, cpu, ram, vram, ip, isActive);
    }
     ...
     */
    static initialize(obj, id, name, cpu, ram, vram, ip, isActive) { 
        obj['id'] = id;
        obj['name'] = name;
        obj['cpu'] = cpu;
        obj['ram'] = ram;
    ...
    /**
     * Constructs a <code>VpsTariff</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VpsTariff} obj Optional instance to populate.
     * @return {module:model/VpsTariff} The populated <code>VpsTariff</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VpsTariff();
    ...
    /**
     * Validates the JSON data with respect to <code>VpsTariff</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VpsTariff</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VpsTariff.RequiredProperties) {
...
VpsTariff.RequiredProperties = ["id", "name", "cpu", "ram", "vram", "ip", "is_active"];

/**
 * ID тарифного плана виртуального сервера.
 * @member {Number} id
 */
VpsTariff.prototype['id'] = undefined;

/**
 * Название тарифа.
 * @member {String} name
 */
VpsTariff.prototype['name'] = undefined;

/**
 * Цена RUB за виртуальное ядро CPU.
 * @member {Number} cpu
 */
VpsTariff.prototype['cpu'] = undefined;

/**
 * Цена RUB за 1 Гб оперативной памяти.
 * @member {Number} ram
 */
VpsTariff.prototype['ram'] = undefined;

/**
 * Цена RUB за 1 Мб видео памяти.
 * @member {Number} vram
 */
VpsTariff.prototype['vram'] = undefined;

/**
 * Цена за 1 дополнительный IP адрес.
 * @member {Number} ip
 */
VpsTariff.prototype['ip'] = undefined;

/**
 * Тариф активен.
 * @member {Boolean} is_active
 */
VpsTariff.prototype['is_active'] = undefined;
