...
/**
 * The AllServersResponse model module.
 * @module model/AllServersResponse
 * @version 2.16
 */
class AllServersResponse {
    /**
     * Constructs a new <code>AllServersResponse</code>.
     * @alias module:model/AllServersResponse
     * @param servers {Array.<module:model/Server>} 
     * @param pagination {module:model/Pagination} 
     */
    constructor(servers, pagination) { 
        
        AllServersResponse.initialize(this, servers, pagination);
    }
     ...
     */
    static initialize(obj, servers, pagination) { 
        obj['servers'] = servers;
        obj['pagination'] = pagination;
    }

    /**
     * Constructs a <code>AllServersResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AllServersResponse} obj Optional instance to populate.
     * @return {module:model/AllServersResponse} The populated <code>AllServersResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllServersResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AllServersResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AllServersResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AllServersResponse.RequiredProperties) {
...
AllServersResponse.RequiredProperties = ["servers", "pagination"];

/**
 * @member {Array.<module:model/Server>} servers
 */
AllServersResponse.prototype['servers'] = undefined;

/**
 * @member {module:model/Pagination} pagination
 */
AllServersResponse.prototype['pagination'] = undefined;
...
export default AllServersResponse;
