...
/**
 * The AdditionalDriveTariff model module.
 * @module model/AdditionalDriveTariff
 * @version 2.16
 */
class AdditionalDriveTariff {
    /**
     * Constructs a new <code>AdditionalDriveTariff</code>.
     * @alias module:model/AdditionalDriveTariff
     * @param id {Number} ID тарифа дополнительного диска.
     * @param name {String} Название тарифа
     * @param price {Number} цена RUB за 1 Гб
     * @param isActive {Boolean} Тариф активен.
     */
    constructor(id, name, price, isActive) { 
        
        AdditionalDriveTariff.initialize(this, id, name, price, isActive);
    }
    ...
    /**
     * Constructs a <code>AdditionalDriveTariff</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdditionalDriveTariff} obj Optional instance to populate.
     * @return {module:model/AdditionalDriveTariff} The populated <code>AdditionalDriveTariff</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdditionalDriveTariff();
    ...
    /**
     * Validates the JSON data with respect to <code>AdditionalDriveTariff</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdditionalDriveTariff</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdditionalDriveTariff.RequiredProperties) {
...
AdditionalDriveTariff.RequiredProperties = ["id", "name", "price", "is_active"];

/**
 * ID тарифа дополнительного диска.
 * @member {Number} id
 */
AdditionalDriveTariff.prototype['id'] = undefined;

/**
 * Название тарифа
 * @member {String} name
 */
AdditionalDriveTariff.prototype['name'] = undefined;

/**
 * цена RUB за 1 Гб
 * @member {Number} price
 */
AdditionalDriveTariff.prototype['price'] = undefined;

/**
 * Тариф активен.
 * @member {Boolean} is_active
 */
AdditionalDriveTariff.prototype['is_active'] = undefined;
...
export default AdditionalDriveTariff;
