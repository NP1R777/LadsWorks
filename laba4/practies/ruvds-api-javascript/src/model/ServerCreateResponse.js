...
/**
 * The ServerCreateResponse model module.
 * @module model/ServerCreateResponse
 * @version 2.16
 */
class ServerCreateResponse {
    /**
     * Constructs a new <code>ServerCreateResponse</code>.
     * @alias module:model/ServerCreateResponse
     */
    constructor() { 
        
        ServerCreateResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServerCreateResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServerCreateResponse} obj Optional instance to populate.
     * @return {module:model/ServerCreateResponse} The populated <code>ServerCreateResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServerCreateResponse();
            ...
            if (data.hasOwnProperty('cost_rub')) {
                obj['cost_rub'] = ApiClient.convertToType(data['cost_rub'], 'Number');
            }
            if (data.hasOwnProperty('password')) {
                obj['password'] = ApiClient.convertToType(data['password'], 'String');
            }
            if (data.hasOwnProperty('action')) {
                obj['action'] = ApiAction.constructFromObject(data['action']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = Server.constructFromObject(data['status']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ServerCreateResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServerCreateResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['action']) { // data not null
          ApiAction.validateJSON(data['action']);
        }
        // validate the optional field `status`
        if (data['status']) { // data not null
          Server.validateJSON(data['status']);
        }
...
/**
 * id виртуального сервера. Используется при получении статуса сервера.
 * @member {Number} virtual_server_id
 */
ServerCreateResponse.prototype['virtual_server_id'] = undefined;

/**
 * @member {module:model/PaymentPeriod} payment_period
 */
ServerCreateResponse.prototype['payment_period'] = undefined;

/**
 * Стоимость сервера в рублях за указанный `payment_period`
 * @member {Number} cost_rub
 */
ServerCreateResponse.prototype['cost_rub'] = undefined;

/**
 * Пароль для подключения сервера.
 * @member {String} password
 */
ServerCreateResponse.prototype['password'] = undefined;

/**
 * @member {module:model/ApiAction} action
 */
ServerCreateResponse.prototype['action'] = undefined;

/**
 * @member {module:model/Server} status
 */
ServerCreateResponse.prototype['status'] = undefined;
...
export default ServerCreateResponse;
