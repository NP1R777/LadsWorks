...
/**
 * The ApiForbiddenError model module.
 * @module model/ApiForbiddenError
 * @version 2.16
 */
class ApiForbiddenError {
    /**
     * Constructs a new <code>ApiForbiddenError</code>.
     * @alias module:model/ApiForbiddenError
     * @param id {module:model/ApiForbiddenError.IdEnum} Короткий идентификатор, соответствующий возвращаемому коду.
     * @param userId {String} Guid пользователя в базе. Может быть использован при дальнейшей отправки запроса для получения разрешения. 
     * @param message {String} Дополнительная информация об ошибке.
     */
    constructor(id, userId, message) { 
        
        ApiForbiddenError.initialize(this, id, userId, message);
    }
     ...
     */
    static initialize(obj, id, userId, message) { 
        obj['id'] = id;
        obj['user_id'] = userId;
        obj['message'] = message;
    }
    ...
    /**
     * Constructs a <code>ApiForbiddenError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiForbiddenError} obj Optional instance to populate.
     * @return {module:model/ApiForbiddenError} The populated <code>ApiForbiddenError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiForbiddenError();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiForbiddenError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiForbiddenError</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiForbiddenError.RequiredProperties) {
...
ApiForbiddenError.RequiredProperties = ["id", "user_id", "message"];

/**
 * Короткий идентификатор, соответствующий возвращаемому коду.
 * @member {module:model/ApiForbiddenError.IdEnum} id
 */
ApiForbiddenError.prototype['id'] = undefined;

/**
 * Guid пользователя в базе. Может быть использован при дальнейшей отправки запроса для получения разрешения. 
 * @member {String} user_id
 */
ApiForbiddenError.prototype['user_id'] = undefined;

/**
 * Дополнительная информация об ошибке.
 * @member {String} message
 */
ApiForbiddenError.prototype['message'] = undefined;
...
ApiForbiddenError['IdEnum'] = {
    ...
    /**
     * value: "phone_not_confirmed"
     * @const
     */
    "phone_not_confirmed": "phone_not_confirmed",

    /**
     * value: "server_creation_forbidden"
     * @const
     */
    "server_creation_forbidden": "server_creation_forbidden"
};
