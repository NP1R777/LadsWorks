...
class ApiError {
     ...
     * @param id {module:model/ApiError.IdEnum} Короткий идентификатор, соответствующий возвращаемому коду. Например, для запроса, вернувшего код 404 значение будет \"not_found\".
     * @param message {String} Дополнительная информация об ошибке.
     */
    constructor(id, message) { 
        
        ApiError.initialize(this, id, message);
    }
...
ApiError.RequiredProperties = ["id", "message"];

/**
 * Короткий идентификатор, соответствующий возвращаемому коду. Например, для запроса, вернувшего код 404 значение будет \"not_found\".
 * @member {module:model/ApiError.IdEnum} id
 */
