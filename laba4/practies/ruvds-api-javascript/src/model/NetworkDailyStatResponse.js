...
/**
 * The NetworkDailyStatResponse model module.
 * @module model/NetworkDailyStatResponse
 * @version 2.16
 */
class NetworkDailyStatResponse {
    /**
     * Constructs a new <code>NetworkDailyStatResponse</code>.
     * @alias module:model/NetworkDailyStatResponse
     * @param networkStat {Array.<module:model/NetworkStat>} 
     */
    constructor(networkStat) { 
        
        NetworkDailyStatResponse.initialize(this, networkStat);
    }
    ...
    /**
     * Constructs a <code>NetworkDailyStatResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NetworkDailyStatResponse} obj Optional instance to populate.
     * @return {module:model/NetworkDailyStatResponse} The populated <code>NetworkDailyStatResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NetworkDailyStatResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>NetworkDailyStatResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NetworkDailyStatResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NetworkDailyStatResponse.RequiredProperties) {
...
NetworkDailyStatResponse.RequiredProperties = ["network_stat"];

/**
 * @member {Array.<module:model/NetworkStat>} network_stat
 */
NetworkDailyStatResponse.prototype['network_stat'] = undefined;
...
export default NetworkDailyStatResponse;
