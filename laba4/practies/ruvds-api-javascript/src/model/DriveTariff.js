...
/**
 * The DriveTariff model module.
 * @module model/DriveTariff
 * @version 2.16
 */
class DriveTariff {
    /**
     * Constructs a new <code>DriveTariff</code>.
     * @alias module:model/DriveTariff
     * @param id {Number} ID тарифа диска.
    ...
    constructor(id, name, price, isActive) { 
        ...
        DriveTariff.initialize(this, id, name, price, isActive);
    }
    ...
    /**
     * Constructs a <code>DriveTariff</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DriveTariff} obj Optional instance to populate.
     * @return {module:model/DriveTariff} The populated <code>DriveTariff</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DriveTariff();
    ...
    /**
     * Validates the JSON data with respect to <code>DriveTariff</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DriveTariff</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DriveTariff.RequiredProperties) {
...
DriveTariff.RequiredProperties = ["id", "name", "price", "is_active"];

/**
 * ID тарифа диска.
 * @member {Number} id
 */
DriveTariff.prototype['id'] = undefined;

/**
 * Название тарифа
 * @member {String} name
 */
DriveTariff.prototype['name'] = undefined;

/**
 * цена RUB за 1 Гб
 * @member {Number} price
 */
DriveTariff.prototype['price'] = undefined;

/**
 * Тариф активен.
 * @member {Boolean} is_active
 */
DriveTariff.prototype['is_active'] = undefined;
