...
/**
 * The AllTokensResponse model module.
 * @module model/AllTokensResponse
 * @version 2.16
 */
class AllTokensResponse {
    /**
     * Constructs a new <code>AllTokensResponse</code>.
     * @alias module:model/AllTokensResponse
     * @param tokens {Array.<module:model/Token>} 
     */
    constructor(tokens) { 
        
        AllTokensResponse.initialize(this, tokens);
    }
    ...
    /**
     * Constructs a <code>AllTokensResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AllTokensResponse} obj Optional instance to populate.
     * @return {module:model/AllTokensResponse} The populated <code>AllTokensResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllTokensResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AllTokensResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AllTokensResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AllTokensResponse.RequiredProperties) {
...
AllTokensResponse.RequiredProperties = ["tokens"];

/**
 * @member {Array.<module:model/Token>} tokens
 */
AllTokensResponse.prototype['tokens'] = undefined;
...
export default AllTokensResponse;
