...
/**
 * The StartPasswordResponse model module.
 * @module model/StartPasswordResponse
 * @version 2.16
 */
class StartPasswordResponse {
    /**
     * Constructs a new <code>StartPasswordResponse</code>.
     * @alias module:model/StartPasswordResponse
     */
    constructor() { 
        
        StartPasswordResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartPasswordResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartPasswordResponse} obj Optional instance to populate.
     * @return {module:model/StartPasswordResponse} The populated <code>StartPasswordResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartPasswordResponse();
            ...
            if (data.hasOwnProperty('password_format')) {
                obj['password_format'] = ApiClient.convertToType(data['password_format'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartPasswordResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartPasswordResponse</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['password_format'] && !(typeof data['password_format'] === 'string' || data['password_format'] instanceof String)) {
            throw new Error("Expected the field `password_format` to be a primitive type in the JSON string but got " + data['password_format']);
        }
 ...
 * @member {String} login
 */
StartPasswordResponse.prototype['login'] = undefined;
 ...
 * @member {module:model/StartPasswordResponse.LoginTypeEnum} login_type
 */
StartPasswordResponse.prototype['login_type'] = undefined;
 ...
 */
StartPasswordResponse.prototype['password'] = undefined;

/**
 * В каком формате представлены байты строки с паролем. Формат зависит от поля `response_format` в запросе.
 * @member {module:model/StartPasswordResponse.PasswordFormatEnum} password_format
 */
StartPasswordResponse.prototype['password_format'] = undefined;
...
/**
 * Allowed values for the <code>login_type</code> property.
 * @enum {String}
 * @readonly
 */
StartPasswordResponse['LoginTypeEnum'] = {
...
/**
 * Allowed values for the <code>password_format</code> property.
 * @enum {String}
 * @readonly
 */
StartPasswordResponse['PasswordFormatEnum'] = {
...
export default StartPasswordResponse;
