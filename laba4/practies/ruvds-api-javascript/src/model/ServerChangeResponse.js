...
/**
 * The ServerChangeResponse model module.
 * @module model/ServerChangeResponse
 * @version 2.16
 */
class ServerChangeResponse {
    /**
     * Constructs a new <code>ServerChangeResponse</code>.
     * @alias module:model/ServerChangeResponse
     */
    constructor() { 
        
        ServerChangeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServerChangeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServerChangeResponse} obj Optional instance to populate.
     * @return {module:model/ServerChangeResponse} The populated <code>ServerChangeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServerChangeResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ServerChangeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServerChangeResponse</code>.
     */
...
/**
 * Количество рублей которое спишется или вернется на баланс после изменения конфигурации. Знак \"-\" означает, что средства вернутся на баланс.
 * @member {Number} cost_rub
 */
ServerChangeResponse.prototype['cost_rub'] = undefined;

/**
 * @member {module:model/ApiAction} action
 */
ServerChangeResponse.prototype['action'] = undefined;
...
export default ServerChangeResponse;
