...
/**
 * The AllActionsResponse model module.
 * @module model/AllActionsResponse
 * @version 2.16
 */
class AllActionsResponse {
    /**
     * Constructs a new <code>AllActionsResponse</code>.
     * @alias module:model/AllActionsResponse
     * @param actions {Array.<module:model/ApiAction>} 
     * @param pagination {module:model/Pagination} 
     */
    constructor(actions, pagination) { 
        
        AllActionsResponse.initialize(this, actions, pagination);
    }
     ...
     */
    static initialize(obj, actions, pagination) { 
        obj['actions'] = actions;
        obj['pagination'] = pagination;
    }

    /**
     * Constructs a <code>AllActionsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AllActionsResponse} obj Optional instance to populate.
     * @return {module:model/AllActionsResponse} The populated <code>AllActionsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllActionsResponse();

            if (data.hasOwnProperty('actions')) {
                obj['actions'] = ApiClient.convertToType(data['actions'], [ApiAction]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AllActionsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AllActionsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AllActionsResponse.RequiredProperties) {
...
AllActionsResponse.RequiredProperties = ["actions", "pagination"];

/**
 * @member {Array.<module:model/ApiAction>} actions
 */
AllActionsResponse.prototype['actions'] = undefined;

/**
 * @member {module:model/Pagination} pagination
 */
AllActionsResponse.prototype['pagination'] = undefined;
...
export default AllActionsResponse;
