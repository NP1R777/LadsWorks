...
import NetworkV4 from './NetworkV4';

/**
 * The ServerNetworksResponse model module.
 * @module model/ServerNetworksResponse
 * @version 2.16
 */
class ServerNetworksResponse {
    /**
     * Constructs a new <code>ServerNetworksResponse</code>.
     * @alias module:model/ServerNetworksResponse
     * @param v4 {Array.<module:model/NetworkV4>} 
     */
    constructor(v4) { 
        
        ServerNetworksResponse.initialize(this, v4);
    }
     ...
     */
    static initialize(obj, v4) { 
        obj['v4'] = v4;
    }

    /**
     * Constructs a <code>ServerNetworksResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServerNetworksResponse} obj Optional instance to populate.
     * @return {module:model/ServerNetworksResponse} The populated <code>ServerNetworksResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServerNetworksResponse();

            if (data.hasOwnProperty('v4')) {
                obj['v4'] = ApiClient.convertToType(data['v4'], [NetworkV4]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ServerNetworksResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServerNetworksResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServerNetworksResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        if (data['v4']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['v4'])) {
                throw new Error("Expected the field `v4` to be an array in the JSON data but got " + data['v4']);
            }
            // validate the optional field `v4` (array)
            for (const item of data['v4']) {
                NetworkV4.validateJSON(item);
            };
        }
...
ServerNetworksResponse.RequiredProperties = ["v4"];

/**
 * @member {Array.<module:model/NetworkV4>} v4
 */
ServerNetworksResponse.prototype['v4'] = undefined;
...
export default ServerNetworksResponse;
