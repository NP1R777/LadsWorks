...
/**
 * The NotificationChange model module.
 * @module model/NotificationChange
 * @version 2.16
 */
class NotificationChange {
    /**
     * Constructs a new <code>NotificationChange</code>.
     * @alias module:model/NotificationChange
     * @param status {module:model/NotificationChange.StatusEnum} Изменить статус оповещения: * `read` - Оповещение прочитано. * `unread` - Оповещение не прочитано.
     */
    constructor(status) { 
        
        NotificationChange.initialize(this, status);
    }
    ...
    /**
     * Constructs a <code>NotificationChange</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NotificationChange} obj Optional instance to populate.
     * @return {module:model/NotificationChange} The populated <code>NotificationChange</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NotificationChange();
    ...
    /**
     * Validates the JSON data with respect to <code>NotificationChange</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NotificationChange</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NotificationChange.RequiredProperties) {
...
NotificationChange.RequiredProperties = ["status"];

/**
 * Изменить статус оповещения: * `read` - Оповещение прочитано. * `unread` - Оповещение не прочитано.
 * @member {module:model/NotificationChange.StatusEnum} status
 */
NotificationChange.prototype['status'] = undefined;
