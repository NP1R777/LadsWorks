...
/**
 * The AdditionalServiceTariff model module.
 * @module model/AdditionalServiceTariff
 * @version 2.16
 */
class AdditionalServiceTariff {
    /**
     * Constructs a new <code>AdditionalServiceTariff</code>.
     * @alias module:model/AdditionalServiceTariff
     * @param id {Number} ID дополнительного сервиса.
     * @param name {String} Название дополнительного сервиса.
     * @param price {Number} Цена за единицу. Единица зависит от типа сервиса.
     * @param isActive {Boolean} Тариф активен.
     */
    constructor(id, name, price, isActive) { 
        
        AdditionalServiceTariff.initialize(this, id, name, price, isActive);
    }
     ...
     */
    static initialize(obj, id, name, price, isActive) { 
        obj['id'] = id;
        obj['name'] = name;
        obj['price'] = price;
    ...
    /**
     * Constructs a <code>AdditionalServiceTariff</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdditionalServiceTariff} obj Optional instance to populate.
     * @return {module:model/AdditionalServiceTariff} The populated <code>AdditionalServiceTariff</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdditionalServiceTariff();
    ...
    /**
     * Validates the JSON data with respect to <code>AdditionalServiceTariff</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdditionalServiceTariff</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdditionalServiceTariff.RequiredProperties) {
...
AdditionalServiceTariff.RequiredProperties = ["id", "name", "price", "is_active"];

/**
 * ID дополнительного сервиса.
 * @member {Number} id
 */
AdditionalServiceTariff.prototype['id'] = undefined;

/**
 * Название дополнительного сервиса.
 * @member {String} name
 */
AdditionalServiceTariff.prototype['name'] = undefined;

/**
 * Цена за единицу. Единица зависит от типа сервиса.
 * @member {Number} price
 */
AdditionalServiceTariff.prototype['price'] = undefined;

/**
 * Тариф активен.
 * @member {Boolean} is_active
 */
AdditionalServiceTariff.prototype['is_active'] = undefined;
...
export default AdditionalServiceTariff;
