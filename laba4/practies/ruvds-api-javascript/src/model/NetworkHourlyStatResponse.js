...
/**
 * The NetworkHourlyStatResponse model module.
 * @module model/NetworkHourlyStatResponse
 * @version 2.16
 */
class NetworkHourlyStatResponse {
    /**
     * Constructs a new <code>NetworkHourlyStatResponse</code>.
     * @alias module:model/NetworkHourlyStatResponse
     * @param networkStat {Array.<module:model/NetworkStat>} 
     */
    constructor(networkStat) { 
        
        NetworkHourlyStatResponse.initialize(this, networkStat);
    }
     ...
     */
    static initialize(obj, networkStat) { 
        obj['network_stat'] = networkStat;
    }

    /**
     * Constructs a <code>NetworkHourlyStatResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NetworkHourlyStatResponse} obj Optional instance to populate.
     * @return {module:model/NetworkHourlyStatResponse} The populated <code>NetworkHourlyStatResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NetworkHourlyStatResponse();

            if (data.hasOwnProperty('network_stat')) {
                obj['network_stat'] = ApiClient.convertToType(data['network_stat'], [NetworkStat]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NetworkHourlyStatResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NetworkHourlyStatResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NetworkHourlyStatResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        if (data['network_stat']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['network_stat'])) {
                throw new Error("Expected the field `network_stat` to be an array in the JSON data but got " + data['network_stat']);
            }
            // validate the optional field `network_stat` (array)
            for (const item of data['network_stat']) {
                NetworkStat.validateJSON(item);
            };
        }
...
NetworkHourlyStatResponse.RequiredProperties = ["network_stat"];

/**
 * @member {Array.<module:model/NetworkStat>} network_stat
 */
NetworkHourlyStatResponse.prototype['network_stat'] = undefined;
...
export default NetworkHourlyStatResponse;
