...
/**
 * The AllOsResponse model module.
 * @module model/AllOsResponse
 * @version 2.16
 */
class AllOsResponse {
    /**
     * Constructs a new <code>AllOsResponse</code>.
     * @alias module:model/AllOsResponse
     * @param os {Array.<module:model/Os>} 
     */
    constructor(os) { 
        
        AllOsResponse.initialize(this, os);
    }
    ...
    /**
     * Constructs a <code>AllOsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AllOsResponse} obj Optional instance to populate.
     * @return {module:model/AllOsResponse} The populated <code>AllOsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllOsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AllOsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AllOsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AllOsResponse.RequiredProperties) {
...
AllOsResponse.RequiredProperties = ["os"];

/**
 * @member {Array.<module:model/Os>} os
 */
AllOsResponse.prototype['os'] = undefined;
