...
/**
 * The DriveHourlyStatResponse model module.
 * @module model/DriveHourlyStatResponse
 * @version 2.16
 */
class DriveHourlyStatResponse {
    /**
     * Constructs a new <code>DriveHourlyStatResponse</code>.
     * @alias module:model/DriveHourlyStatResponse
     * @param driveStat {Array.<module:model/DriveStat>} 
     */
    constructor(driveStat) { 
        
        DriveHourlyStatResponse.initialize(this, driveStat);
    }
     ...
     */
    static initialize(obj, driveStat) { 
        obj['drive_stat'] = driveStat;
    }

    /**
     * Constructs a <code>DriveHourlyStatResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DriveHourlyStatResponse} obj Optional instance to populate.
     * @return {module:model/DriveHourlyStatResponse} The populated <code>DriveHourlyStatResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DriveHourlyStatResponse();

            if (data.hasOwnProperty('drive_stat')) {
                obj['drive_stat'] = ApiClient.convertToType(data['drive_stat'], [DriveStat]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DriveHourlyStatResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DriveHourlyStatResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DriveHourlyStatResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        if (data['drive_stat']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['drive_stat'])) {
                throw new Error("Expected the field `drive_stat` to be an array in the JSON data but got " + data['drive_stat']);
            }
            // validate the optional field `drive_stat` (array)
            for (const item of data['drive_stat']) {
                DriveStat.validateJSON(item);
            };
        }
...
DriveHourlyStatResponse.RequiredProperties = ["drive_stat"];

/**
 * @member {Array.<module:model/DriveStat>} drive_stat
 */
DriveHourlyStatResponse.prototype['drive_stat'] = undefined;
...
export default DriveHourlyStatResponse;
