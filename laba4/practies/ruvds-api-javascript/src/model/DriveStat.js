...
/**
 * The DriveStat model module.
 * @module model/DriveStat
 * @version 2.16
 */
class DriveStat {
    /**
     * Constructs a new <code>DriveStat</code>.
     * @alias module:model/DriveStat
     * @param addDt {Date} Время формирования статистики.
     * @param readIops {Number} Среднее чтение с диска в IOPS.
     * @param writeIops {Number} Средняя запись на диск в IOPS.
     */
    constructor(addDt, readIops, writeIops) { 
        
        DriveStat.initialize(this, addDt, readIops, writeIops);
    }
     ...
     */
    static initialize(obj, addDt, readIops, writeIops) { 
        obj['add_dt'] = addDt;
        obj['read_iops'] = readIops;
        obj['write_iops'] = writeIops;
    }

    /**
     * Constructs a <code>DriveStat</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DriveStat} obj Optional instance to populate.
     * @return {module:model/DriveStat} The populated <code>DriveStat</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DriveStat();

            if (data.hasOwnProperty('add_dt')) {
                obj['add_dt'] = ApiClient.convertToType(data['add_dt'], 'Date');
            }
            if (data.hasOwnProperty('read_iops')) {
                obj['read_iops'] = ApiClient.convertToType(data['read_iops'], 'Number');
            }
            if (data.hasOwnProperty('write_iops')) {
                obj['write_iops'] = ApiClient.convertToType(data['write_iops'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DriveStat</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DriveStat</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DriveStat.RequiredProperties) {
...
DriveStat.RequiredProperties = ["add_dt", "read_iops", "write_iops"];

/**
 * Время формирования статистики.
 * @member {Date} add_dt
 */
DriveStat.prototype['add_dt'] = undefined;

/**
 * Среднее чтение с диска в IOPS.
 * @member {Number} read_iops
 */
DriveStat.prototype['read_iops'] = undefined;

/**
 * Средняя запись на диск в IOPS.
 * @member {Number} write_iops
 */
DriveStat.prototype['write_iops'] = undefined;
