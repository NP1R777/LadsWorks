...
* @readonly
*/
export default class PaymentPeriod {
    ...
    /**
    * Returns a <code>PaymentPeriod</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PaymentPeriod} The enum <code>PaymentPeriod</code> value.
    */
