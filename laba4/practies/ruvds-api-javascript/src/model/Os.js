...
class Os {
     ...
     * @param id {Number} ID операционной системы.
     * @param name {String} Название операционной системы.
     * @param isActive {Boolean} Операционная система доступна для создания.
     */
    constructor(id, name, isActive) { 
        
        Os.initialize(this, id, name, isActive);
    }
     ...
     */
    static initialize(obj, id, name, isActive) { 
        obj['id'] = id;
        obj['name'] = name;
    ...
    static validateJSON(data) {
        ...
        for (const property of Os.RequiredProperties) {
...
Os.RequiredProperties = ["id", "name", "is_active"];

/**
 * ID операционной системы.
 * @member {Number} id
 */
Os.prototype['id'] = undefined;

/**
 * Название операционной системы.
 * @member {String} name
 */
Os.prototype['name'] = undefined;

/**
 * Операционная система доступна для создания.
 * @member {Boolean} is_active
 */
Os.prototype['is_active'] = undefined;
