...
/**
 * The CpuDailyStatResponse model module.
 * @module model/CpuDailyStatResponse
 * @version 2.16
 */
class CpuDailyStatResponse {
    /**
     * Constructs a new <code>CpuDailyStatResponse</code>.
     * @alias module:model/CpuDailyStatResponse
     * @param cpuStat {Array.<module:model/CpuStat>} 
     */
    constructor(cpuStat) { 
        
        CpuDailyStatResponse.initialize(this, cpuStat);
    }
    ...
    /**
     * Constructs a <code>CpuDailyStatResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CpuDailyStatResponse} obj Optional instance to populate.
     * @return {module:model/CpuDailyStatResponse} The populated <code>CpuDailyStatResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CpuDailyStatResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CpuDailyStatResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CpuDailyStatResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CpuDailyStatResponse.RequiredProperties) {
...
CpuDailyStatResponse.RequiredProperties = ["cpu_stat"];

/**
 * @member {Array.<module:model/CpuStat>} cpu_stat
 */
CpuDailyStatResponse.prototype['cpu_stat'] = undefined;
...
export default CpuDailyStatResponse;
