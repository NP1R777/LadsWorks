...
/**
 * The DriveDailyStatResponse model module.
 * @module model/DriveDailyStatResponse
 * @version 2.16
 */
class DriveDailyStatResponse {
    /**
     * Constructs a new <code>DriveDailyStatResponse</code>.
     * @alias module:model/DriveDailyStatResponse
     * @param driveStat {Array.<module:model/DriveStat>} 
     */
    constructor(driveStat) { 
        
        DriveDailyStatResponse.initialize(this, driveStat);
    }
    ...
    /**
     * Constructs a <code>DriveDailyStatResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DriveDailyStatResponse} obj Optional instance to populate.
     * @return {module:model/DriveDailyStatResponse} The populated <code>DriveDailyStatResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DriveDailyStatResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DriveDailyStatResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DriveDailyStatResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DriveDailyStatResponse.RequiredProperties) {
...
DriveDailyStatResponse.RequiredProperties = ["drive_stat"];

/**
 * @member {Array.<module:model/DriveStat>} drive_stat
 */
DriveDailyStatResponse.prototype['drive_stat'] = undefined;
...
export default DriveDailyStatResponse;
