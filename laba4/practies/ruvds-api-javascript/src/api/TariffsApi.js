...
export default class TariffsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the tariffsList operation.
     * @callback module:api/TariffsApi~tariffsListCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AllTariffsResponse} data The data returned by the service call.
     ...
     * @param {module:api/TariffsApi~tariffsListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AllTariffsResponse}
     */
    tariffsList(callback) {
      let postBody = null;
      ...
      let returnType = AllTariffsResponse;
