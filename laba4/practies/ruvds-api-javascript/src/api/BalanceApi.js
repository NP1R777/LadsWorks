...
export default class BalanceApi {
    ...
    */
     ...
     * @callback module:api/BalanceApi~balanceGetCallback
     ...
     * @param {module:model/Number} [currencyId = 1)] В какой валюте получить значение баланса. * `1` - RUB * `3` - USD * `4` - EUR
     * @param {module:api/BalanceApi~balanceGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Balance}
     */
    balanceGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
