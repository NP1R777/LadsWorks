...
export default class DatacentersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the datacentersList operation.
     * @callback module:api/DatacentersApi~datacentersListCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AllDatacentersResponse} data The data returned by the service call.
     ...
     * @param {module:api/DatacentersApi~datacentersListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AllDatacentersResponse}
     */
    datacentersList(callback) {
      let postBody = null;
      ...
      let returnType = AllDatacentersResponse;
