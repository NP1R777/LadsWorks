...
export default class TemplatesApi {
    ...
    */
     ...
     * @param {module:model/AllTemplatesResponse} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/AllTemplatesResponse}
     */
    templatesList(callback) {
      ...
      let returnType = AllTemplatesResponse;
