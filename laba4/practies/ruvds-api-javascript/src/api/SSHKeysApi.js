...
export default class SSHKeysApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the sshKeysCreate operation.
     * @callback module:api/SSHKeysApi~sshKeysCreateCallback
     ...
     * @param {module:model/SshKeyCreate} [sshKeyCreate] 
     * @param {module:api/SSHKeysApi~sshKeysCreateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SshKey}
     */
    sshKeysCreate(opts, callback) {
      opts = opts || {};
      let postBody = opts['sshKeyCreate'];
    ...
    /**
     * Callback function to receive the result of the sshKeysDelete operation.
     * @callback module:api/SSHKeysApi~sshKeysDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} sshKeyId Уникальный ID SSH ключа.
     * @param {module:api/SSHKeysApi~sshKeysDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    sshKeysDelete(sshKeyId, callback) {
      let postBody = null;
      // verify the required parameter 'sshKeyId' is set
      if (sshKeyId === undefined || sshKeyId === null) {
        throw new Error("Missing the required parameter 'sshKeyId' when calling sshKeysDelete");
      }
     ...
     * data is of type: {@link module:model/SshKey}
     */
    sshKeysGet(sshKeyId, callback) {
      let postBody = null;
      // verify the required parameter 'sshKeyId' is set
      if (sshKeyId === undefined || sshKeyId === null) {
        throw new Error("Missing the required parameter 'sshKeyId' when calling sshKeysGet");
      }
    ...
    /**
     * Callback function to receive the result of the sshKeysList operation.
     * @callback module:api/SSHKeysApi~sshKeysListCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AllSshKeys} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SSHKeysApi~sshKeysListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AllSshKeys}
     */
    sshKeysList(callback) {
      let postBody = null;
