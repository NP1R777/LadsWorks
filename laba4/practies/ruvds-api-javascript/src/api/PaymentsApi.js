...
export default class PaymentsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the paymentsList operation.
     * @callback module:api/PaymentsApi~paymentsListCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AllPaymentsResponse} data The data returned by the service call.
     ...
     * @param {module:model/String} [type = 'default')] Тип запрашиваемого баланса. * `default` - Денежный баланс. * `bonus` - Количество бонусных баллов. * `partner` - Партнерские начисления.
     * @param {Number} [perPage = 25)] Количество элементов на одной странице
     * @param {Number} [page = 1)] Номер страницы в результате
     * @param {module:model/String} [sort = 'dt')] * `dt` - Сортировка по полю `dt`. 
     * @param {module:model/String} [order = 'asc')] * `asc` - Сортировка по возрастанию.  * `desc` - Сортировка по убыванию. 
     * @param {module:api/PaymentsApi~paymentsListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AllPaymentsResponse}
     */
    paymentsList(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = AllPaymentsResponse;
