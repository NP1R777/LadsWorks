...
export default class OSApi {
    ...
    /**
    * Constructs a new OSApi. 
    * @alias module:api/OSApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the osList operation.
     * @callback module:api/OSApi~osListCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AllOsResponse} data The data returned by the service call.
     ...
     * @param {module:api/OSApi~osListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AllOsResponse}
     */
    osList(callback) {
      let postBody = null;
